...
active proctype process3()
{
	...
	channelT3 ? iRead, ADRESSE_X, r1, _;
	}
	atomic{
...
{
	atomic{
	channelT4 ! iRead, ADRESSE_Y, NULL, NULL;
	channelT4 ? iRead, ADRESSE_Y, r3, _;
	}
	atomic{
	channelT4 ! iRead, ADRESSE_X, NULL, NULL;
	channelT4 ? iRead, ADRESSE_X, r4, _;
	}
