...
public class UnsupportedInstructionPropertyChecker extends AbstractPropertyChecker {
   ...
   private void generateUnsupportedString(String instructionName, FunctionDefinition functionDefinition) {
      String result = "Instruction of type " + instructionName + " in function " + functionDefinition.getAddress().getName()
            + " is unsupported.";
      addMessage(result);
   }
   ...
   /**
    * Returns the name of the class that is used for implementation of the instruction if
    * unsupported, else null.
    * 
    * @param instruction
    * @return
    */
   ...
   protected void setSemanticsToPerformChecksFor() {
      addSemanticToPerformChecksFor(EMemoryModel.SC);
