...
public class PropertyCheckerManager {
   ...
   private EMemoryModel memoryModelToPerformChecksFor;


   public PropertyCheckerManager(EMemoryModel memoryModelToPerformChecksFor) {
      this.memoryModelToPerformChecksFor = memoryModelToPerformChecksFor;
   ...
   public void performChecks() {
      ...
      for (AbstractPropertyChecker propertyChecker : checkerModules) {
         if (propertyChecker.shouldPerformChecksForSemantic(memoryModelToPerformChecksFor)) {
   ...
   /**
    * Returns the status of the check which describes if warnings and/ or errors were found.
    * 
    ...
    *         {@link PropertyCheckerManager#STATUS_WARNING_FOUND}, if a warning was found , if both
    *         an error and a warning were found, the error is rated higher and therefore the error
    *         case is returned
    */
