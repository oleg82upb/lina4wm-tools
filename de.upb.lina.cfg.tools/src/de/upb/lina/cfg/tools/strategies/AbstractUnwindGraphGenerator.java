...
public abstract class AbstractUnwindGraphGenerator implements IGraphGenerator
{
	...
	//need parent FunctionDefinition as key in order to distinguish
	protected HashMap<FunctionDefinition, ArrayList<Instruction>> instructions;
	
	

	public AbstractUnwindGraphGenerator(FunctionDefinition function)
	{
		// intialize variables
	...
	{
		//TODO alles neu machen für automatische Call Unwinds
		//größte Probleme:
		//TODO: PCs und Variablen müssen evtl. geprefixt werden (Namespace) 
		//TODO: Callstack oder etwas ähnliches nachbauen
