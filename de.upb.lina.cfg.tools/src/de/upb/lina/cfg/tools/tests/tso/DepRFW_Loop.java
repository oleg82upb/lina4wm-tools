...
public class DepRFW_Loop extends TSOStoreBufferGraphTest {
   ...
   {
      return Arrays.asList("L6 <(r1: v0" + CFGConstants.WDC_SUFFIX + ")>", "L7 <(r1: v0" + CFGConstants.WDC_SUFFIX + ")>", "L8 <(r1: v0"
            + CFGConstants.WDC_SUFFIX + ")>", "L3 <(r1: v0" + CFGConstants.WDC_SUFFIX + ")>", "L4 <(r1: v0" + CFGConstants.WDC_SUFFIX
            + ")>");
   }
}
