...
import de.upb.lina.cfg.tools.tests.tso.DepWR_12_boothLoop;
...
@RunWith(Suite.class)
@SuiteClasses({ RU_T_DepWR.class, RU_T_IndWR.class, RU_T_DepWR_1.class, RU_T_DepWR_1_1.class, RU_T_DepWR_12.class,
		RU_T_DepWR_2.class, RU_T_DepWR_2_1.class, RU_T_IndWR_1.class, RU_T_IndWR_1_1.class, RU_T_IndWR_2_1.class,
		RU_T_IndWR_2.class, Dependent_Write_Read_1_1_rev.class, Independent_Write_Read_1_1_rev.class,
		DepWR_12_boothLoop.class, DepWR_1_1_fencedLoop.class, DepWR_2_1_cmpxchLoop.class, IndWR_2_1_cmpxchLoop.class,
		IndWR_1_1_fencedLoop.class, DepRFW_Loop.class })
