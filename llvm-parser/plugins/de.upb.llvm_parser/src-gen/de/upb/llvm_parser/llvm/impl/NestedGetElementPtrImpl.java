 ...
 *   <li>{@link de.upb.llvm_parser.llvm.impl.NestedGetElementPtrImpl#getAggregatename <em>Aggregatename</em>}</li>
...
public class NestedGetElementPtrImpl extends ValueImpl implements NestedGetElementPtr {
	...
	public NotificationChain basicSetAggregatename(Value newAggregatename, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LlvmPackage.NESTED_GET_ELEMENT_PTR__AGGREGATENAME, oldAggregatename, newAggregatename);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAggregatename(Value newAggregatename) {
		if (newAggregatename != aggregatename) {
			...
			if (aggregatename != null)
				msgs = ((InternalEObject)aggregatename).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.NESTED_GET_ELEMENT_PTR__AGGREGATENAME, null, msgs);
			if (newAggregatename != null)
				msgs = ((InternalEObject)newAggregatename).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.NESTED_GET_ELEMENT_PTR__AGGREGATENAME, null, msgs);
			msgs = basicSetAggregatename(newAggregatename, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LlvmPackage.NESTED_GET_ELEMENT_PTR__AGGREGATENAME, newAggregatename, newAggregatename));
	}
