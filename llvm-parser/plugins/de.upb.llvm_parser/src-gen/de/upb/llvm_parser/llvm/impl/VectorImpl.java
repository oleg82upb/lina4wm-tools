 ...
 * <ul>
 *   <li>{@link de.upb.llvm_parser.llvm.impl.VectorImpl#getLength <em>Length</em>}</li>
 *   <li>{@link de.upb.llvm_parser.llvm.impl.VectorImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VectorImpl extends Aggregate_TypesImpl implements Vector
{
  ...
  {
		return LlvmPackage.Literals.VECTOR;
	}
  ...
  public NotificationChain basicSetType(TypeUse newType, NotificationChain msgs)
  {
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LlvmPackage.VECTOR__TYPE, oldType, newType);
  ...
  public void setType(TypeUse newType)
  {
		if (newType != type)
		{
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.VECTOR__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.VECTOR__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LlvmPackage.VECTOR__TYPE, newType, newType));
	}
