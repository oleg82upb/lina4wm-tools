...
public class LOGICAL_OPImpl extends InstructionImpl implements LOGICAL_OP {
	...
	public NotificationChain basicSetOptype(TypeUse newOptype, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LlvmPackage.LOGICAL_OP__OPTYPE, oldOptype, newOptype);
	...
	public void setOptype(TypeUse newOptype) {
		if (newOptype != optype) {
			...
			if (optype != null)
				msgs = ((InternalEObject)optype).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.LOGICAL_OP__OPTYPE, null, msgs);
			if (newOptype != null)
				msgs = ((InternalEObject)newOptype).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.LOGICAL_OP__OPTYPE, null, msgs);
			msgs = basicSetOptype(newOptype, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LlvmPackage.LOGICAL_OP__OPTYPE, newOptype, newOptype));
	}
	...
	public NotificationChain basicSetValue1(Value newValue1, NotificationChain msgs) {
		...
		value1 = newValue1;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LlvmPackage.LOGICAL_OP__VALUE1, oldValue1, newValue1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValue1(Value newValue1) {
		if (newValue1 != value1) {
			NotificationChain msgs = null;
			if (value1 != null)
				msgs = ((InternalEObject)value1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.LOGICAL_OP__VALUE1, null, msgs);
			if (newValue1 != null)
				msgs = ((InternalEObject)newValue1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.LOGICAL_OP__VALUE1, null, msgs);
			msgs = basicSetValue1(newValue1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LlvmPackage.LOGICAL_OP__VALUE1, newValue1, newValue1));
	}
	...
	public NotificationChain basicSetValue2(Value newValue2, NotificationChain msgs) {
		...
		value2 = newValue2;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LlvmPackage.LOGICAL_OP__VALUE2, oldValue2, newValue2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValue2(Value newValue2) {
		if (newValue2 != value2) {
			NotificationChain msgs = null;
			if (value2 != null)
				msgs = ((InternalEObject)value2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.LOGICAL_OP__VALUE2, null, msgs);
			if (newValue2 != null)
				msgs = ((InternalEObject)newValue2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LlvmPackage.LOGICAL_OP__VALUE2, null, msgs);
			msgs = basicSetValue2(newValue2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LlvmPackage.LOGICAL_OP__VALUE2, newValue2, newValue2));
	}
