...
public interface Resume extends Ret_Instr {
	...
	/**
	 * Returns the value of the '<em><b>Resumevalue</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Resumevalue</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Resumevalue</em>' attribute.
	 * @see #setResumevalue(String)
	...
	/**
	 * Sets the value of the '{@link de.upb.llvm_parser.llvm.Resume#getResumevalue <em>Resumevalue</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Resumevalue</em>' attribute.
	 * @see #getResumevalue()
	 * @generated
	 */
	void setResumevalue(String value);
