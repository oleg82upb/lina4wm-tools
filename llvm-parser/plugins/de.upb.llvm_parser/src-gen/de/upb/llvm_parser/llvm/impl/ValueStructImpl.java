...
public class ValueStructImpl extends MinimalEObjectImpl.Container implements ValueStruct {
	...
	public EList<String> getTypes() {
		if (types == null) {
			types = new EDataTypeEList<String>(String.class, this, LlvmPackage.VALUE_STRUCT__TYPES);
		}
		return types;
	}
	...
	public EList<String> getValue() {
		if (value == null) {
			value = new EDataTypeEList<String>(String.class, this, LlvmPackage.VALUE_STRUCT__VALUE);
		}
		return value;
	}
