...
public class ARITHMETIC_OPImpl extends InstructionImpl implements ARITHMETIC_OP {
	...
	public void setOptype(String newOptype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LlvmPackage.ARITHMETIC_OP__OPTYPE, oldOptype, optype));
	}
	...
	public void setValue1(String newValue1) {
		...
		value1 = newValue1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LlvmPackage.ARITHMETIC_OP__VALUE1, oldValue1, value1));
	}
	...
	public void setValue2(String newValue2) {
		...
		value2 = newValue2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LlvmPackage.ARITHMETIC_OP__VALUE2, oldValue2, value2));
	}
