		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLocalAliasAccess().getGroup(), "rule__LocalAlias__Group__0");
					...
					put(grammarAccess.getLocalVarAccess().getTypeAssignment_2_0(), "rule__LocalVar__TypeAssignment_2_0");
					...
					put(grammarAccess.getLocalInstructionAccess().getInstrAssignment(), "rule__LocalInstruction__InstrAssignment");
					put(grammarAccess.getLocalAliasAccess().getTypeAssignment_3(), "rule__LocalAlias__TypeAssignment_3");
					put(grammarAccess.getLocalAliasAccess().getAliaseeAssignment_4(), "rule__LocalAlias__AliaseeAssignment_4");
