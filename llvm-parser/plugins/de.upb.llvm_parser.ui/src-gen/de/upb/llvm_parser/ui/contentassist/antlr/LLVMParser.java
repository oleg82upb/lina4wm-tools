		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeAndValueAccess().getTypeAlternatives_0_0(), "rule__TypeAndValue__TypeAlternatives_0_0");
					...
					put(grammarAccess.getFPointAccess().getAlternatives(), "rule__FPoint__Alternatives");
					...
					put(grammarAccess.getFunctionHeaderAccess().getReturnTypeAssignment_5(), "rule__FunctionHeader__ReturnTypeAssignment_5");
					put(grammarAccess.getFunctionHeaderAccess().getNameAssignment_6(), "rule__FunctionHeader__NameAssignment_6");
					put(grammarAccess.getFunctionHeaderAccess().getPListAssignment_7(), "rule__FunctionHeader__PListAssignment_7");
