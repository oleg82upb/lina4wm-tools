...
%"class.boost::detail::thread_data" = type { %"struct.boost::detail::thread_data_base", %struct.thread_alarm }
...
%"class.boost::gregorian::greg_month" = type { %"class.boost::CV::constrained_value.32" }
%"class.boost::CV::constrained_value.32" = type { i16 }
%"class.boost::gregorian::greg_day" = type { %"class.boost::CV::constrained_value.33" }
%"class.boost::CV::constrained_value.33" = type { i16 }
%"struct.boost::less_than_comparable.22" = type { i8 }
...
%"struct.boost::exception_detail::error_info_injector" = type { %"struct.boost::gregorian::bad_day_of_month", %"class.boost::exception" }
...
%"struct.boost::exception_detail::error_info_injector.35" = type { %"struct.boost::gregorian::bad_month", %"class.boost::exception" }
%"class.boost::exception_detail::clone_impl.34" = type { %"struct.boost::exception_detail::error_info_injector.35", %"class.boost::exception_detail::clone_base" }
...
%"struct.boost::exception_detail::error_info_injector.38" = type { %"struct.boost::gregorian::bad_year", %"class.boost::exception" }
%"class.boost::exception_detail::clone_impl.37" = type { %"struct.boost::exception_detail::error_info_injector.38", %"class.boost::exception_detail::clone_base" }
...
%"struct.boost::less_than_comparable.27" = type { i8 }
%"class.boost::date_time::int_adapter.40" = type { i32 }
%struct.tm = type { i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8* }
%struct.timeval = type { i32, i32 }
%struct.timezone = type { i32, i32 }
%"struct.boost::exception_detail::error_info_injector.42" = type { %"class.std::runtime_error", %"class.boost::exception" }
%"class.boost::exception_detail::clone_impl.41" = type { %"struct.boost::exception_detail::error_info_injector.42", %"class.boost::exception_detail::clone_base" }
%"struct.boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::runtime_error> >::clone_tag" = type { i8 }
%"struct.std::_Rb_tree_node" = type { %"struct.std::_Rb_tree_node_base", %"struct.std::pair.44" }
%"struct.std::pair.44" = type { i8*, %"struct.boost::detail::tss_data_node" }
%"struct.boost::detail::tss_data_node" = type { %"class.boost::shared_ptr.45", i8* }
%"class.boost::shared_ptr.45" = type { %"struct.boost::detail::tss_cleanup_function"*, %"class.boost::detail::shared_count" }
...
%"struct.boost::exception_detail::error_info_injector.50" = type { %"class.boost::thread_resource_error", %"class.boost::exception" }
%"class.boost::exception_detail::clone_impl.49" = type { %"struct.boost::exception_detail::error_info_injector.50", %"class.boost::exception_detail::clone_base" }
...
@.str13 = private unnamed_addr constant [31 x i8] c"setting alarm for 5 seconds...\00", align 1
...
@_ZTVN5boost6detail11thread_dataI12thread_alarmEE = linkonce_odr unnamed_addr constant [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTIN5boost6detail11thread_dataI12thread_alarmEE to i8*), i8* bitcast (void (%"class.boost::detail::thread_data"*)* @_ZN5boost6detail11thread_dataI12thread_alarmED1Ev to i8*), i8* bitcast (void (%"class.boost::detail::thread_data"*)* @_ZN5boost6detail11thread_dataI12thread_alarmED0Ev to i8*), i8* bitcast (void (%"class.boost::detail::thread_data"*)* @_ZN5boost6detail11thread_dataI12thread_alarmE3runEv to i8*)]
@_ZTSN5boost6detail11thread_dataI12thread_alarmEE = linkonce_odr constant [45 x i8] c"N5boost6detail11thread_dataI12thread_alarmEE\00"
@_ZTIN5boost6detail16thread_data_baseE = external constant i8*
@_ZTIN5boost6detail11thread_dataI12thread_alarmEE = linkonce_odr unnamed_addr constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i32 2) to i8*), i8* getelementptr inbounds ([45 x i8]* @_ZTSN5boost6detail11thread_dataI12thread_alarmEE, i32 0, i32 0), i8* bitcast (i8** @_ZTIN5boost6detail16thread_data_baseE to i8*) }
@.str14 = private unnamed_addr constant [17 x i8] c"alarm sounded...\00", align 1
@.str15 = private unnamed_addr constant [41 x i8] c"Day of month value is out of range 1..31\00", align 1
...
@_ZTVN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEE = linkonce_odr unnamed_addr constant [21 x i8*] [i8* inttoptr (i32 28 to i8*), i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED0Ev to i8*), i8* bitcast (i8* (%"class.std::logic_error"*)* @_ZNKSt11logic_error4whatEv to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE7rethrowEv to i8*), i8* inttoptr (i32 -8 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED0Ev to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEE to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl"*)* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE7rethrowEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED0Ev to i8*)]
...
@_ZTVN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEE = linkonce_odr unnamed_addr constant [9 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector"*)* @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector"*)* @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED0Ev to i8*), i8* bitcast (i8* (%"class.std::logic_error"*)* @_ZNKSt11logic_error4whatEv to i8*), i8* inttoptr (i32 -8 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector"*)* @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector"*)* @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED0Ev to i8*)]
...
@.str16 = private unnamed_addr constant [35 x i8] c"Month number is out of range 1..12\00", align 1
...
@_ZTVN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEE = linkonce_odr unnamed_addr constant [21 x i8*] [i8* inttoptr (i32 28 to i8*), i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.34"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.34"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED0Ev to i8*), i8* bitcast (i8* (%"class.std::logic_error"*)* @_ZNKSt11logic_error4whatEv to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl.34"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.34"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE7rethrowEv to i8*), i8* inttoptr (i32 -8 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.34"*)* @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.34"*)* @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED0Ev to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEE to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl.34"*)* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.34"*)* @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE7rethrowEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.34"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.34"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED0Ev to i8*)]
...
@_ZTVN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEE = linkonce_odr unnamed_addr constant [9 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.35"*)* @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.35"*)* @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED0Ev to i8*), i8* bitcast (i8* (%"class.std::logic_error"*)* @_ZNKSt11logic_error4whatEv to i8*), i8* inttoptr (i32 -8 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.35"*)* @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.35"*)* @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED0Ev to i8*)]
@.str17 = private unnamed_addr constant [40 x i8] c"Year is out of valid range: 1400..10000\00", align 1
...
@_ZTVN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEE = linkonce_odr unnamed_addr constant [21 x i8*] [i8* inttoptr (i32 28 to i8*), i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.37"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.37"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED0Ev to i8*), i8* bitcast (i8* (%"class.std::logic_error"*)* @_ZNKSt11logic_error4whatEv to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl.37"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.37"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE7rethrowEv to i8*), i8* inttoptr (i32 -8 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.37"*)* @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.37"*)* @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED0Ev to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEE to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl.37"*)* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.37"*)* @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE7rethrowEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.37"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.37"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED0Ev to i8*)]
...
@_ZTVN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEE = linkonce_odr unnamed_addr constant [9 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.38"*)* @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.38"*)* @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED0Ev to i8*), i8* bitcast (i8* (%"class.std::logic_error"*)* @_ZNKSt11logic_error4whatEv to i8*), i8* inttoptr (i32 -8 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.38"*)* @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.38"*)* @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED0Ev to i8*)]
@.str18 = private unnamed_addr constant [35 x i8] c"Day of month is not valid for year\00", align 1
@.str19 = private unnamed_addr constant [44 x i8] c"could not convert calendar time to UTC time\00", align 1
...
@_ZTVN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEE = linkonce_odr unnamed_addr constant [21 x i8*] [i8* inttoptr (i32 28 to i8*), i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED0Ev to i8*), i8* bitcast (i8* (%"class.std::runtime_error"*)* @_ZNKSt13runtime_error4whatEv to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl.41"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE7rethrowEv to i8*), i8* inttoptr (i32 -8 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED0Ev to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* inttoptr (i32 -28 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEE to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl.41"*)* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE7rethrowEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED0Ev to i8*)]
...
@_ZTVN5boost16exception_detail19error_info_injectorISt13runtime_errorEE = linkonce_odr unnamed_addr constant [9 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorISt13runtime_errorEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.42"*)* @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.42"*)* @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED0Ev to i8*), i8* bitcast (i8* (%"class.std::runtime_error"*)* @_ZNKSt13runtime_error4whatEv to i8*), i8* inttoptr (i32 -8 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorISt13runtime_errorEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.42"*)* @_ZThn8_N5boost16exception_detail19error_info_injectorISt13runtime_errorED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.42"*)* @_ZThn8_N5boost16exception_detail19error_info_injectorISt13runtime_errorED0Ev to i8*)]
...
@.str20 = private unnamed_addr constant [40 x i8] c"!pthread_mutex_destroy(&internal_mutex)\00", align 1
@.str21 = private unnamed_addr constant [74 x i8] c"/home/thomas/boost_1_52_0/boost/thread/pthread/condition_variable_fwd.hpp\00", align 1
...
@.str22 = private unnamed_addr constant [5 x i8] c"!ret\00", align 1
@.str23 = private unnamed_addr constant [68 x i8] c"boost:: condition_variable constructor failed in pthread_mutex_init\00", align 1
...
@.str24 = private unnamed_addr constant [67 x i8] c"boost:: condition_variable constructor failed in pthread_cond_init\00", align 1
...
@_ZTVN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEE = linkonce_odr unnamed_addr constant [21 x i8*] [i8* inttoptr (i32 40 to i8*), i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED0Ev to i8*), i8* bitcast (i8* (%"class.boost::system::system_error"*)* @_ZNK5boost6system12system_error4whatEv to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl.49"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE7rethrowEv to i8*), i8* inttoptr (i32 -20 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZThn20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZThn20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED0Ev to i8*), i8* inttoptr (i32 -40 to i8*), i8* inttoptr (i32 -40 to i8*), i8* inttoptr (i32 -40 to i8*), i8* inttoptr (i32 -40 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEE to i8*), i8* bitcast (%"class.boost::exception_detail::clone_base"* (%"class.boost::exception_detail::clone_impl.49"*)* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE5cloneEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE7rethrowEv to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED0Ev to i8*)]
...
@_ZTVN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEE = linkonce_odr unnamed_addr constant [9 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.50"*)* @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.50"*)* @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED0Ev to i8*), i8* bitcast (i8* (%"class.boost::system::system_error"*)* @_ZNK5boost6system12system_error4whatEv to i8*), i8* inttoptr (i32 -20 to i8*), i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEE to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.50"*)* @_ZThn20_N5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED1Ev to i8*), i8* bitcast (void (%"struct.boost::exception_detail::error_info_injector.50"*)* @_ZThn20_N5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED0Ev to i8*)]
@.str25 = private unnamed_addr constant [55 x i8] c"boost:: mutex constructor failed in pthread_mutex_init\00", align 1
@_ZTVN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEE = linkonce_odr unnamed_addr constant [7 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTIN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEE to i8*), i8* bitcast (void (%"class.boost::detail::sp_counted_impl_p"*)* @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEED1Ev to i8*), i8* bitcast (void (%"class.boost::detail::sp_counted_impl_p"*)* @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEED0Ev to i8*), i8* bitcast (void (%"class.boost::detail::sp_counted_impl_p"*)* @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEE7disposeEv to i8*), i8* bitcast (void (%"class.boost::detail::sp_counted_base"*)* @_ZN5boost6detail15sp_counted_base7destroyEv to i8*), i8* bitcast (i8* (%"class.boost::detail::sp_counted_impl_p"*, %"class.std::type_info"*)* @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEE11get_deleterERKSt9type_info to i8*)]
@_ZTSN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEE = linkonce_odr constant [71 x i8] c"N5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEE\00"
...
@_ZTIN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEE = linkonce_odr unnamed_addr constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i32 2) to i8*), i8* getelementptr inbounds ([71 x i8]* @_ZTSN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEE, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTIN5boost6detail15sp_counted_baseE to i8*) }
...
entry:
  ...
  %alarm = alloca %struct.thread_alarm, align 4
  %thrd = alloca %"class.boost::thread", align 4
  %agg.tmp = alloca %struct.thread_alarm, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store i32 5, i32* %secs, align 4
  %call = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([31 x i8]* @.str13, i32 0, i32 0))
  %call1 = call %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %call, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %0 = load i32* %secs, align 4
  call void @_ZN12thread_alarmC1Ei(%struct.thread_alarm* %alarm, i32 %0)
  %1 = bitcast %struct.thread_alarm* %agg.tmp to i8*
  %2 = bitcast %struct.thread_alarm* %alarm to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %1, i8* %2, i32 4, i32 4, i1 false)
  call void @_ZN5boost6threadC1I12thread_alarmEET_NS_10disable_ifINS_14is_convertibleIRS3_NS_6detail13thread_move_tIS3_EEEEPNS0_5dummyEE4typeE(%"class.boost::thread"* %thrd, %struct.thread_alarm* byval align 4 %agg.tmp, %"struct.boost::thread::dummy"* null)
  invoke void @_ZN5boost6thread4joinEv(%"class.boost::thread"* %thrd)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZN5boost6threadD1Ev(%"class.boost::thread"* %thrd)
  ret i32 0
...
lpad:                                             ; preds = %entry
  ...
  invoke void @_ZN5boost6threadD1Ev(%"class.boost::thread"* %thrd)
...
define linkonce_odr void @_ZN12thread_alarmC1Ei(%struct.thread_alarm* %this, i32 %secs) unnamed_addr align 2 {
entry:
  %this.addr = alloca %struct.thread_alarm*, align 4
  %secs.addr = alloca i32, align 4
  store %struct.thread_alarm* %this, %struct.thread_alarm** %this.addr, align 4
  store i32 %secs, i32* %secs.addr, align 4
  %this1 = load %struct.thread_alarm** %this.addr
  %0 = load i32* %secs.addr, align 4
  call void @_ZN12thread_alarmC2Ei(%struct.thread_alarm* %this1, i32 %0)
  ret void
}

define linkonce_odr void @_ZN5boost6threadC1I12thread_alarmEET_NS_10disable_ifINS_14is_convertibleIRS3_NS_6detail13thread_move_tIS3_EEEEPNS0_5dummyEE4typeE(%"class.boost::thread"* %this, %struct.thread_alarm* byval align 4 %f, %"struct.boost::thread::dummy"*) unnamed_addr align 2 {
entry:
  ...
  call void @_ZN5boost6threadC2I12thread_alarmEET_NS_10disable_ifINS_14is_convertibleIRS3_NS_6detail13thread_move_tIS3_EEEEPNS0_5dummyEE4typeE(%"class.boost::thread"* %this1, %struct.thread_alarm* byval align 4 %f, %"struct.boost::thread::dummy"* %1)
  ret void
}
...
define linkonce_odr void @_ZN5boost6threadC2I12thread_alarmEET_NS_10disable_ifINS_14is_convertibleIRS3_NS_6detail13thread_move_tIS3_EEEEPNS0_5dummyEE4typeE(%"class.boost::thread"* %this, %struct.thread_alarm* byval align 4 %f, %"struct.boost::thread::dummy"*) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::thread"*, align 4
  %.addr = alloca %"struct.boost::thread::dummy"*, align 4
  %agg.tmp = alloca %struct.thread_alarm, align 4
  ...
  %1 = bitcast %struct.thread_alarm* %agg.tmp to i8*
  %2 = bitcast %struct.thread_alarm* %f to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %1, i8* %2, i32 4, i32 4, i1 false)
  call void @_ZN5boost6thread16make_thread_infoI12thread_alarmEENS_10shared_ptrINS_6detail16thread_data_baseEEET_(%"class.boost::shared_ptr"* sret %thread_info, %struct.thread_alarm* byval align 4 %agg.tmp)
...
define linkonce_odr void @_ZN5boost6thread16make_thread_infoI12thread_alarmEENS_10shared_ptrINS_6detail16thread_data_baseEEET_(%"class.boost::shared_ptr"* noalias sret %agg.result, %struct.thread_alarm* byval align 4 %f) inlinehint align 2 {
entry:
  %call = call %"class.boost::detail::thread_data"* @_ZN5boost6detail8heap_newINS0_11thread_dataI12thread_alarmEES3_EEPT_RT0_(%struct.thread_alarm* %f)
  call void @_ZN5boost10shared_ptrINS_6detail16thread_data_baseEEC1INS1_11thread_dataI12thread_alarmEEEEPT_(%"class.boost::shared_ptr"* %agg.result, %"class.boost::detail::thread_data"* %call)
  ret void
}
...
define linkonce_odr void @_ZN5boost10shared_ptrINS_6detail16thread_data_baseEEC1INS1_11thread_dataI12thread_alarmEEEEPT_(%"class.boost::shared_ptr"* %this, %"class.boost::detail::thread_data"* %p) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::shared_ptr"*, align 4
  ...
  call void @_ZN5boost10shared_ptrINS_6detail16thread_data_baseEEC2INS1_11thread_dataI12thread_alarmEEEEPT_(%"class.boost::shared_ptr"* %this1, %"class.boost::detail::thread_data"* %0)
  ret void
}

define linkonce_odr %"class.boost::detail::thread_data"* @_ZN5boost6detail8heap_newINS0_11thread_dataI12thread_alarmEES3_EEPT_RT0_(%struct.thread_alarm* %a1) inlinehint {
entry:
  %a1.addr = alloca %struct.thread_alarm*, align 4
  store %struct.thread_alarm* %a1, %struct.thread_alarm** %a1.addr, align 4
  %0 = load %struct.thread_alarm** %a1.addr, align 4
  %call = call %"class.boost::detail::thread_data"* @_ZN5boost6detail13heap_new_implINS0_11thread_dataI12thread_alarmEERS3_EEPT_T0_(%struct.thread_alarm* %0)
  ret %"class.boost::detail::thread_data"* %call
}

define linkonce_odr %"class.boost::detail::thread_data"* @_ZN5boost6detail13heap_new_implINS0_11thread_dataI12thread_alarmEERS3_EEPT_T0_(%struct.thread_alarm* %a1) inlinehint {
entry:
  %a1.addr = alloca %struct.thread_alarm*, align 4
  %agg.tmp = alloca %struct.thread_alarm, align 4
  %exn.slot = alloca i8*
  ...
  %1 = load %struct.thread_alarm** %a1.addr, align 4
  %2 = bitcast %struct.thread_alarm* %agg.tmp to i8*
  %3 = bitcast %struct.thread_alarm* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %2, i8* %3, i32 4, i32 4, i1 false)
  invoke void @_ZN5boost6detail11thread_dataI12thread_alarmEC1ES2_(%"class.boost::detail::thread_data"* %0, %struct.thread_alarm* byval align 4 %agg.tmp)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZN5boost6detail11thread_dataI12thread_alarmEC1ES2_(%"class.boost::detail::thread_data"* %this, %struct.thread_alarm* byval align 4 %f_) unnamed_addr align 2 {
entry:
  ...
  call void @_ZN5boost6detail11thread_dataI12thread_alarmEC2ES2_(%"class.boost::detail::thread_data"* %this1, %struct.thread_alarm* byval align 4 %f_)
  ret void
}

declare void @_ZdlPv(i8*) nounwind

define linkonce_odr void @_ZN5boost6detail11thread_dataI12thread_alarmEC2ES2_(%"class.boost::detail::thread_data"* %this, %struct.thread_alarm* byval align 4 %f_) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::thread_data"*, align 4
  store %"class.boost::detail::thread_data"* %this, %"class.boost::detail::thread_data"** %this.addr, align 4
  %this1 = load %"class.boost::detail::thread_data"** %this.addr
  ...
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTVN5boost6detail11thread_dataI12thread_alarmEE, i64 0, i64 2), i8*** %1
  %f = getelementptr inbounds %"class.boost::detail::thread_data"* %this1, i32 0, i32 1
  %2 = bitcast %struct.thread_alarm* %f to i8*
  %3 = bitcast %struct.thread_alarm* %f_ to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %2, i8* %3, i32 4, i32 4, i1 false)
  ret void
}
...
define linkonce_odr void @_ZN5boost6detail11thread_dataI12thread_alarmED1Ev(%"class.boost::detail::thread_data"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::thread_data"*, align 4
  store %"class.boost::detail::thread_data"* %this, %"class.boost::detail::thread_data"** %this.addr, align 4
  %this1 = load %"class.boost::detail::thread_data"** %this.addr
  call void @_ZN5boost6detail11thread_dataI12thread_alarmED2Ev(%"class.boost::detail::thread_data"* %this1)
  ret void
}

define linkonce_odr void @_ZN5boost6detail11thread_dataI12thread_alarmED0Ev(%"class.boost::detail::thread_data"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::thread_data"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.boost::detail::thread_data"* %this, %"class.boost::detail::thread_data"** %this.addr, align 4
  %this1 = load %"class.boost::detail::thread_data"** %this.addr
  invoke void @_ZN5boost6detail11thread_dataI12thread_alarmED1Ev(%"class.boost::detail::thread_data"* %this1)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZN5boost6detail11thread_dataI12thread_alarmE3runEv(%"class.boost::detail::thread_data"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::thread_data"*, align 4
  store %"class.boost::detail::thread_data"* %this, %"class.boost::detail::thread_data"** %this.addr, align 4
  %this1 = load %"class.boost::detail::thread_data"** %this.addr
  %f = getelementptr inbounds %"class.boost::detail::thread_data"* %this1, i32 0, i32 1
  call void @_ZN12thread_alarmclEv(%struct.thread_alarm* %f)
  ret void
}

define linkonce_odr void @_ZN12thread_alarmclEv(%struct.thread_alarm* %this) align 2 {
entry:
  %this.addr = alloca %struct.thread_alarm*, align 4
  ...
  store %struct.thread_alarm* %this, %struct.thread_alarm** %this.addr, align 4
  %this1 = load %struct.thread_alarm** %this.addr
  %call = call i32 @_ZN5boost9xtime_getEPNS_5xtimeEi(%"struct.boost::xtime"* %xt, i32 1)
  %m_secs = getelementptr inbounds %struct.thread_alarm* %this1, i32 0, i32 0
  %0 = load i32* %m_secs, align 4
  ...
  call void @_ZNK5boost5xtimecvNS_10posix_time5ptimeEEv(%"class.boost::posix_time::ptime"* sret %ref.tmp, %"struct.boost::xtime"* %xt)
  call void @_ZN5boost6thread5sleepERKNS_10posix_time5ptimeE(%"class.boost::posix_time::ptime"* %ref.tmp)
  %call2 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([17 x i8]* @.str14, i32 0, i32 0))
...
entry:
  ...
  %0 = bitcast %"class.boost::date_time::time_duration"* %this1 to %"struct.boost::less_than_comparable.22"*
...
entry:
  ...
  store i16 %day_of_month, i16* %day_of_month.addr, align 2
  %this1 = load %"class.boost::gregorian::greg_day"** %this.addr
  %0 = bitcast %"class.boost::gregorian::greg_day"* %this1 to %"class.boost::CV::constrained_value.33"*
  %1 = load i16* %day_of_month.addr, align 2
  call void @_ZN5boost2CV17constrained_valueINS0_23simple_exception_policyItLt1ELt31ENS_9gregorian16bad_day_of_monthEEEEC2Et(%"class.boost::CV::constrained_value.33"* %0, i16 zeroext %1)
  ret void
}

define linkonce_odr void @_ZN5boost2CV17constrained_valueINS0_23simple_exception_policyItLt1ELt31ENS_9gregorian16bad_day_of_monthEEEEC2Et(%"class.boost::CV::constrained_value.33"* %this, i16 zeroext %value) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::CV::constrained_value.33"*, align 4
  %value.addr = alloca i16, align 2
  store %"class.boost::CV::constrained_value.33"* %this, %"class.boost::CV::constrained_value.33"** %this.addr, align 4
  store i16 %value, i16* %value.addr, align 2
  %this1 = load %"class.boost::CV::constrained_value.33"** %this.addr
  %value_ = getelementptr inbounds %"class.boost::CV::constrained_value.33"* %this1, i32 0, i32 0
  ...
  call void @_ZN5boost2CV17constrained_valueINS0_23simple_exception_policyItLt1ELt31ENS_9gregorian16bad_day_of_monthEEEE6assignEt(%"class.boost::CV::constrained_value.33"* %this1, i16 zeroext %0)
  ret void
}
...
define linkonce_odr void @_ZN5boost2CV17constrained_valueINS0_23simple_exception_policyItLt1ELt31ENS_9gregorian16bad_day_of_monthEEEE6assignEt(%"class.boost::CV::constrained_value.33"* %this, i16 zeroext %value) align 2 {
entry:
  %this.addr = alloca %"class.boost::CV::constrained_value.33"*, align 4
  %value.addr = alloca i16, align 2
  store %"class.boost::CV::constrained_value.33"* %this, %"class.boost::CV::constrained_value.33"** %this.addr, align 4
...
if.then8:                                         ; preds = %if.end
  %value_9 = getelementptr inbounds %"class.boost::CV::constrained_value.33"* %this1, i32 0, i32 0
...
if.end10:                                         ; preds = %if.end
  ...
  %value_11 = getelementptr inbounds %"class.boost::CV::constrained_value.33"* %this1, i32 0, i32 0
...
entry:
  ...
  invoke void @_ZN5boost17enable_error_infoINS_9gregorian16bad_day_of_monthEEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS5_(%"struct.boost::exception_detail::error_info_injector"* sret %ref.tmp, %"struct.boost::gregorian::bad_day_of_month"* %3)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  invoke void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEENS1_10clone_implIT_EERKS7_(%"class.boost::exception_detail::clone_impl"* sret %2, %"struct.boost::exception_detail::error_info_injector"* %ref.tmp)
          to label %invoke.cont2 unwind label %lpad1

invoke.cont2:                                     ; preds = %invoke.cont
  store i1 false, i1* %cleanup.isactive
  invoke void @__cxa_throw(i8* %exception, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev to i8*)) noreturn
...
lpad1:                                            ; preds = %invoke.cont2, %invoke.cont
  ...
  %9 = extractvalue { i8*, i32 } %7, 1
  store i32 %9, i32* %ehselector.slot
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector"* %ref.tmp) nounwind
  br label %ehcleanup
...
entry:
  ...
  invoke void @_ZNSsC1EPKcRKSaIcE(%"class.std::basic_string"* %ref.tmp, i8* getelementptr inbounds ([41 x i8]* @.str15, i32 0, i32 0), %"class.std::allocator"* %ref.tmp2)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEENS1_10clone_implIT_EERKS7_(%"class.boost::exception_detail::clone_impl"* noalias sret %agg.result, %"struct.boost::exception_detail::error_info_injector"* %x) inlinehint {
entry:
  ...
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl"* %agg.result, %"struct.boost::exception_detail::error_info_injector"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost17enable_error_infoINS_9gregorian16bad_day_of_monthEEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS5_(%"struct.boost::exception_detail::error_info_injector"* noalias sret %agg.result, %"struct.boost::gregorian::bad_day_of_month"* %x) inlinehint {
entry:
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEC1ERKS3_(%"struct.boost::exception_detail::error_info_injector"* %agg.result, %"struct.boost::gregorian::bad_day_of_month"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr nounwind align 2 {
entry:
  ...
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED2Ev(%"class.boost::exception_detail::clone_impl"* %this1, i8** getelementptr inbounds ([2 x i8*]* @_ZTTN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEE, i64 0, i64 0)) nounwind
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector"* %this) unnamed_addr nounwind align 2 {
entry:
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector"* %this1) nounwind
  ret void
}

declare void @__cxa_free_exception(i8*)

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector"*, align 4
  store %"struct.boost::exception_detail::error_info_injector"* %this, %"struct.boost::exception_detail::error_info_injector"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector"** %this.addr
  ...
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector"* %this1 to %"struct.boost::gregorian::bad_day_of_month"*
  call void @_ZN5boost9gregorian16bad_day_of_monthD2Ev(%"struct.boost::gregorian::bad_day_of_month"* %3) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector"*, align 4
  store %"struct.boost::exception_detail::error_info_injector"* %this, %"struct.boost::exception_detail::error_info_injector"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector"** %this.addr
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector"* %2) nounwind
  ret void
}
...
define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED2Ev(%"class.boost::exception_detail::clone_impl"* %this, i8** %vtt) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector"* %0) nounwind
  ret void
}
...
define linkonce_odr void @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  store %"class.boost::exception_detail::clone_impl"* %this, %"class.boost::exception_detail::clone_impl"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl"** %this.addr
  ...
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  store %"class.boost::exception_detail::clone_impl"* %this, %"class.boost::exception_detail::clone_impl"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl"** %this.addr
  ...
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  store %"class.boost::exception_detail::clone_impl"* %this, %"class.boost::exception_detail::clone_impl"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl"** %this.addr
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl"* %this1) nounwind
  %0 = bitcast %"class.boost::exception_detail::clone_impl"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE5cloneEv(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  ...
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEC1ERKS6_NS6_9clone_tagE(%"class.boost::exception_detail::clone_impl"* %0, %"class.boost::exception_detail::clone_impl"* %this1)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  ...
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEC1ERKS6_(%"class.boost::exception_detail::clone_impl"* %0, %"class.boost::exception_detail::clone_impl"* %this1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @__cxa_throw(i8* %exception, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED1Ev to i8*)) noreturn
  unreachable
...
define linkonce_odr void @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  store %"class.boost::exception_detail::clone_impl"* %this, %"class.boost::exception_detail::clone_impl"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_impl"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl"* %2) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE5cloneEv(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  store %"class.boost::exception_detail::clone_impl"* %this, %"class.boost::exception_detail::clone_impl"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl"*
  %call = call %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE5cloneEv(%"class.boost::exception_detail::clone_impl"* %7)
  ret %"class.boost::exception_detail::clone_base"* %call
}

define linkonce_odr void @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  store %"class.boost::exception_detail::clone_impl"* %this, %"class.boost::exception_detail::clone_impl"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl"*
  call void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl"* %7)
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  store %"class.boost::exception_detail::clone_impl"* %this, %"class.boost::exception_detail::clone_impl"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEC1ERKS6_(%"class.boost::exception_detail::clone_impl"* %this, %"class.boost::exception_detail::clone_impl"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  ...
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector"* %9, %"struct.boost::exception_detail::error_info_injector"* %11)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector"* %this, %"struct.boost::exception_detail::error_info_injector"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector"*, align 4
  ...
  %this1 = load %"struct.boost::exception_detail::error_info_injector"** %this.addr
  %1 = bitcast %"struct.boost::exception_detail::error_info_injector"* %this1 to %"struct.boost::gregorian::bad_day_of_month"*
  %2 = load %"struct.boost::exception_detail::error_info_injector"** %.addr, align 4
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector"* %2 to %"struct.boost::gregorian::bad_day_of_month"*
...
lpad:                                             ; preds = %entry
  ...
  %15 = extractvalue { i8*, i32 } %13, 1
  store i32 %15, i32* %ehselector.slot
  %16 = bitcast %"struct.boost::exception_detail::error_info_injector"* %this1 to %"struct.boost::gregorian::bad_day_of_month"*
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED0Ev(%"struct.boost::exception_detail::error_info_injector"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector"*, align 4
  store %"struct.boost::exception_detail::error_info_injector"* %this, %"struct.boost::exception_detail::error_info_injector"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector"** %this.addr
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector"* %this1) nounwind
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED0Ev(%"struct.boost::exception_detail::error_info_injector"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector"*, align 4
  store %"struct.boost::exception_detail::error_info_injector"* %this, %"struct.boost::exception_detail::error_info_injector"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"struct.boost::exception_detail::error_info_injector"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED0Ev(%"struct.boost::exception_detail::error_info_injector"* %2) nounwind
  ret void
}
...
define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEC1ERKS6_NS6_9clone_tagE(%"class.boost::exception_detail::clone_impl"* %this, %"class.boost::exception_detail::clone_impl"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  ...
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector"* %4, %"struct.boost::exception_detail::error_info_injector"* %6)
          to label %invoke.cont unwind label %lpad
...
lpad5:                                            ; preds = %cast.end
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector"* %24) nounwind
  br label %ehcleanup
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEC1ERKS3_(%"struct.boost::exception_detail::error_info_injector"* %this, %"struct.boost::gregorian::bad_day_of_month"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector"*, align 4
  %x.addr = alloca %"struct.boost::gregorian::bad_day_of_month"*, align 4
  store %"struct.boost::exception_detail::error_info_injector"* %this, %"struct.boost::exception_detail::error_info_injector"** %this.addr, align 4
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector"* %this1, %"struct.boost::gregorian::bad_day_of_month"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector"* %this, %"struct.boost::gregorian::bad_day_of_month"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector"*, align 4
  %x.addr = alloca %"struct.boost::gregorian::bad_day_of_month"*, align 4
  %exn.slot = alloca i8*
  ...
  store %"struct.boost::gregorian::bad_day_of_month"* %x, %"struct.boost::gregorian::bad_day_of_month"** %x.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector"* %this1 to %"struct.boost::gregorian::bad_day_of_month"*
...
lpad:                                             ; preds = %entry
  ...
  %10 = extractvalue { i8*, i32 } %8, 1
  store i32 %10, i32* %ehselector.slot
  %11 = bitcast %"struct.boost::exception_detail::error_info_injector"* %this1 to %"struct.boost::gregorian::bad_day_of_month"*
...
define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian16bad_day_of_monthEEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl"* %this, %"struct.boost::exception_detail::error_info_injector"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl"*, align 4
  %x.addr = alloca %"struct.boost::exception_detail::error_info_injector"*, align 4
  %exn.slot = alloca i8*
  ...
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector"* %3, %"struct.boost::exception_detail::error_info_injector"* %4)
          to label %invoke.cont unwind label %lpad
...
lpad5:                                            ; preds = %cast.end
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian16bad_day_of_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector"* %22) nounwind
  br label %ehcleanup
...
entry:
  ...
  store i16 %theMonth, i16* %theMonth.addr, align 2
  %this1 = load %"class.boost::gregorian::greg_month"** %this.addr
  %0 = bitcast %"class.boost::gregorian::greg_month"* %this1 to %"class.boost::CV::constrained_value.32"*
  %1 = load i16* %theMonth.addr, align 2
  call void @_ZN5boost2CV17constrained_valueINS0_23simple_exception_policyItLt1ELt12ENS_9gregorian9bad_monthEEEEC2Et(%"class.boost::CV::constrained_value.32"* %0, i16 zeroext %1)
  ret void
}

define linkonce_odr void @_ZN5boost2CV17constrained_valueINS0_23simple_exception_policyItLt1ELt12ENS_9gregorian9bad_monthEEEEC2Et(%"class.boost::CV::constrained_value.32"* %this, i16 zeroext %value) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::CV::constrained_value.32"*, align 4
  %value.addr = alloca i16, align 2
  store %"class.boost::CV::constrained_value.32"* %this, %"class.boost::CV::constrained_value.32"** %this.addr, align 4
  store i16 %value, i16* %value.addr, align 2
  %this1 = load %"class.boost::CV::constrained_value.32"** %this.addr
  %value_ = getelementptr inbounds %"class.boost::CV::constrained_value.32"* %this1, i32 0, i32 0
  ...
  store i16 %call, i16* %value_, align 2
  %0 = load i16* %value.addr, align 2
  call void @_ZN5boost2CV17constrained_valueINS0_23simple_exception_policyItLt1ELt12ENS_9gregorian9bad_monthEEEE6assignEt(%"class.boost::CV::constrained_value.32"* %this1, i16 zeroext %0)
  ret void
}
...
define linkonce_odr void @_ZN5boost2CV17constrained_valueINS0_23simple_exception_policyItLt1ELt12ENS_9gregorian9bad_monthEEEE6assignEt(%"class.boost::CV::constrained_value.32"* %this, i16 zeroext %value) align 2 {
entry:
  %this.addr = alloca %"class.boost::CV::constrained_value.32"*, align 4
  %value.addr = alloca i16, align 2
  store %"class.boost::CV::constrained_value.32"* %this, %"class.boost::CV::constrained_value.32"** %this.addr, align 4
...
if.then8:                                         ; preds = %if.end
  %value_9 = getelementptr inbounds %"class.boost::CV::constrained_value.32"* %this1, i32 0, i32 0
  %4 = load i16* %value_9, align 2
  %5 = load i16* %value.addr, align 2
...
if.end10:                                         ; preds = %if.end
  %6 = load i16* %value.addr, align 2
  %value_11 = getelementptr inbounds %"class.boost::CV::constrained_value.32"* %this1, i32 0, i32 0
  store i16 %6, i16* %value_11, align 2
  br label %return
...
entry:
  ...
  %ref.tmp = alloca %"struct.boost::exception_detail::error_info_injector.35", align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  %cleanup.isactive = alloca i1
  ...
  %exception = call i8* @__cxa_allocate_exception(i32 32) nounwind
  store i1 true, i1* %cleanup.isactive
  %2 = bitcast i8* %exception to %"class.boost::exception_detail::clone_impl.34"*
  %3 = load %"struct.boost::gregorian::bad_month"** %e.addr, align 4
  invoke void @_ZN5boost17enable_error_infoINS_9gregorian9bad_monthEEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS5_(%"struct.boost::exception_detail::error_info_injector.35"* sret %ref.tmp, %"struct.boost::gregorian::bad_month"* %3)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  invoke void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEEEENS1_10clone_implIT_EERKS7_(%"class.boost::exception_detail::clone_impl.34"* sret %2, %"struct.boost::exception_detail::error_info_injector.35"* %ref.tmp)
          to label %invoke.cont2 unwind label %lpad1

invoke.cont2:                                     ; preds = %invoke.cont
  store i1 false, i1* %cleanup.isactive
  invoke void @__cxa_throw(i8* %exception, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.34"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev to i8*)) noreturn
          to label %unreachable unwind label %lpad1
...
lpad1:                                            ; preds = %invoke.cont2, %invoke.cont
  ...
  %9 = extractvalue { i8*, i32 } %7, 1
  store i32 %9, i32* %ehselector.slot
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector.35"* %ref.tmp) nounwind
  br label %ehcleanup
...
entry:
  ...
  %0 = bitcast %"struct.boost::gregorian::bad_month"* %this1 to %"class.std::out_of_range"*
  call void @_ZNSaIcEC1Ev(%"class.std::allocator"* %ref.tmp2) nounwind
  invoke void @_ZNSsC1EPKcRKSaIcE(%"class.std::basic_string"* %ref.tmp, i8* getelementptr inbounds ([35 x i8]* @.str16, i32 0, i32 0), %"class.std::allocator"* %ref.tmp2)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEEEENS1_10clone_implIT_EERKS7_(%"class.boost::exception_detail::clone_impl.34"* noalias sret %agg.result, %"struct.boost::exception_detail::error_info_injector.35"* %x) inlinehint {
entry:
  %x.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.35"* %x, %"struct.boost::exception_detail::error_info_injector.35"** %x.addr, align 4
  %0 = load %"struct.boost::exception_detail::error_info_injector.35"** %x.addr, align 4
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl.34"* %agg.result, %"struct.boost::exception_detail::error_info_injector.35"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost17enable_error_infoINS_9gregorian9bad_monthEEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS5_(%"struct.boost::exception_detail::error_info_injector.35"* noalias sret %agg.result, %"struct.boost::gregorian::bad_month"* %x) inlinehint {
entry:
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEC1ERKS3_(%"struct.boost::exception_detail::error_info_injector.35"* %agg.result, %"struct.boost::gregorian::bad_month"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED2Ev(%"class.boost::exception_detail::clone_impl.34"* %this1, i8** getelementptr inbounds ([2 x i8*]* @_ZTTN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEE, i64 0, i64 0)) nounwind
  %0 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 28
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %2) nounwind
  ret void
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector.35"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::exception_detail::error_info_injector.35"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.35"** %this.addr
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector.35"* %this1) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector.35"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::exception_detail::error_info_injector.35"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.35"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 8
  %2 = bitcast i8* %1 to %"class.boost::exception"*
  call void @_ZN5boost9exceptionD2Ev(%"class.boost::exception"* %2) nounwind
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to %"struct.boost::gregorian::bad_month"*
  call void @_ZN5boost9gregorian9bad_monthD2Ev(%"struct.boost::gregorian::bad_month"* %3) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector.35"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::exception_detail::error_info_injector.35"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.35"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"struct.boost::exception_detail::error_info_injector.35"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector.35"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED2Ev(%"class.boost::exception_detail::clone_impl.34"* %this, i8** %vtt) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  %vtt.addr = alloca i8**, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  %vtt2 = load i8*** %vtt.addr
  %0 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to %"struct.boost::exception_detail::error_info_injector.35"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector.35"* %0) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  %0 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_impl.34"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl.34"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  ...
  %5 = load i32* %4
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.34"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl.34"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED1Ev(%"class.boost::exception_detail::clone_impl.34"* %this1) nounwind
  %0 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE5cloneEv(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  %call = call noalias i8* @_Znwj(i32 32)
  %0 = bitcast i8* %call to %"class.boost::exception_detail::clone_impl.34"*
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEC1ERKS6_NS6_9clone_tagE(%"class.boost::exception_detail::clone_impl.34"* %0, %"class.boost::exception_detail::clone_impl.34"* %this1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %1 = icmp eq %"class.boost::exception_detail::clone_impl.34"* %0, null
  br i1 %1, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %2 = bitcast %"class.boost::exception_detail::clone_impl.34"* %0 to i8**
  %vtable = load i8** %2
  %vbase.offset.ptr = getelementptr i8* %vtable, i64 -12
  %3 = bitcast i8* %vbase.offset.ptr to i32*
  %vbase.offset = load i32* %3
  %4 = bitcast %"class.boost::exception_detail::clone_impl.34"* %0 to i8*
  %add.ptr = getelementptr inbounds i8* %4, i32 %vbase.offset
  %5 = bitcast i8* %add.ptr to %"class.boost::exception_detail::clone_base"*
  br label %cast.end
...
define linkonce_odr void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  %exception = call i8* @__cxa_allocate_exception(i32 32) nounwind
  %0 = bitcast i8* %exception to %"class.boost::exception_detail::clone_impl.34"*
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEC1ERKS6_(%"class.boost::exception_detail::clone_impl.34"* %0, %"class.boost::exception_detail::clone_impl.34"* %this1)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_impl.34"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl.34"* %2) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE5cloneEv(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.34"*
  %call = call %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE5cloneEv(%"class.boost::exception_detail::clone_impl.34"* %7)
  ret %"class.boost::exception_detail::clone_base"* %call
}

define linkonce_odr void @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.34"*
  call void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.34"* %7)
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl.34"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.34"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEED0Ev(%"class.boost::exception_detail::clone_impl.34"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEC1ERKS6_(%"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  %.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %0, %"class.boost::exception_detail::clone_impl.34"** %.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  %1 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %2 = getelementptr inbounds i8* %1, i64 28
  %3 = bitcast i8* %2 to %"class.boost::exception_detail::clone_base"*
  %4 = load %"class.boost::exception_detail::clone_impl.34"** %.addr, align 4
  %5 = bitcast %"class.boost::exception_detail::clone_impl.34"* %4 to i8**
  %vtable = load i8** %5
  %vbase.offset.ptr = getelementptr i8* %vtable, i64 -12
  %6 = bitcast i8* %vbase.offset.ptr to i32*
  %vbase.offset = load i32* %6
  %7 = bitcast %"class.boost::exception_detail::clone_impl.34"* %4 to i8*
  %add.ptr = getelementptr inbounds i8* %7, i32 %vbase.offset
  %8 = bitcast i8* %add.ptr to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2ERKS1_(%"class.boost::exception_detail::clone_base"* %3, %"class.boost::exception_detail::clone_base"* %8) nounwind
  %9 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to %"struct.boost::exception_detail::error_info_injector.35"*
  %10 = load %"class.boost::exception_detail::clone_impl.34"** %.addr, align 4
  %11 = bitcast %"class.boost::exception_detail::clone_impl.34"* %10 to %"struct.boost::exception_detail::error_info_injector.35"*
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector.35"* %9, %"struct.boost::exception_detail::error_info_injector.35"* %11)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %12 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8***
  ...
  %13 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %add.ptr2 = getelementptr inbounds i8* %13, i32 8
  %14 = bitcast i8* %add.ptr2 to i8***
  ...
  %15 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %add.ptr3 = getelementptr inbounds i8* %15, i32 28
  %16 = bitcast i8* %add.ptr3 to i8***
...
lpad:                                             ; preds = %entry
  ...
  %19 = extractvalue { i8*, i32 } %17, 1
  store i32 %19, i32* %ehselector.slot
  %20 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %21 = getelementptr inbounds i8* %20, i64 28
  %22 = bitcast i8* %21 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %22) nounwind
  br label %eh.resume
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::exception_detail::error_info_injector.35"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  %.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::exception_detail::error_info_injector.35"** %this.addr, align 4
  store %"struct.boost::exception_detail::error_info_injector.35"* %0, %"struct.boost::exception_detail::error_info_injector.35"** %.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.35"** %this.addr
  %1 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to %"struct.boost::gregorian::bad_month"*
  %2 = load %"struct.boost::exception_detail::error_info_injector.35"** %.addr, align 4
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %2 to %"struct.boost::gregorian::bad_month"*
  call void @_ZN5boost9gregorian9bad_monthC2ERKS1_(%"struct.boost::gregorian::bad_month"* %1, %"struct.boost::gregorian::bad_month"* %3)
  %4 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to i8*
  %5 = getelementptr inbounds i8* %4, i64 8
  %6 = bitcast i8* %5 to %"class.boost::exception"*
  %7 = load %"struct.boost::exception_detail::error_info_injector.35"** %.addr, align 4
  %8 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %7 to i8*
  %add.ptr = getelementptr inbounds i8* %8, i32 8
  %9 = bitcast i8* %add.ptr to %"class.boost::exception"*
  invoke void @_ZN5boost9exceptionC2ERKS0_(%"class.boost::exception"* %6, %"class.boost::exception"* %9)
          to label %invoke.cont unwind label %lpad
...
invoke.cont:                                      ; preds = %entry
  %10 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to i8***
  ...
  %11 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to i8*
  %add.ptr2 = getelementptr inbounds i8* %11, i32 8
  %12 = bitcast i8* %add.ptr2 to i8***
...
lpad:                                             ; preds = %entry
  ...
  %15 = extractvalue { i8*, i32 } %13, 1
  store i32 %15, i32* %ehselector.slot
  %16 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to %"struct.boost::gregorian::bad_month"*
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED0Ev(%"struct.boost::exception_detail::error_info_injector.35"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::exception_detail::error_info_injector.35"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.35"** %this.addr
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED1Ev(%"struct.boost::exception_detail::error_info_injector.35"* %this1) nounwind
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED0Ev(%"struct.boost::exception_detail::error_info_injector.35"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::exception_detail::error_info_injector.35"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.35"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"struct.boost::exception_detail::error_info_injector.35"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED0Ev(%"struct.boost::exception_detail::error_info_injector.35"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEC1ERKS6_NS6_9clone_tagE(%"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  %x.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  ...
  %ehselector.slot = alloca i32
  store %"class.boost::exception_detail::clone_impl.34"* %this, %"class.boost::exception_detail::clone_impl.34"** %this.addr, align 4
  store %"class.boost::exception_detail::clone_impl.34"* %x, %"class.boost::exception_detail::clone_impl.34"** %x.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.34"** %this.addr
  %1 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %2 = getelementptr inbounds i8* %1, i64 28
  %3 = bitcast i8* %2 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2Ev(%"class.boost::exception_detail::clone_base"* %3) nounwind
  %4 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to %"struct.boost::exception_detail::error_info_injector.35"*
  %5 = load %"class.boost::exception_detail::clone_impl.34"** %x.addr, align 4
  %6 = bitcast %"class.boost::exception_detail::clone_impl.34"* %5 to %"struct.boost::exception_detail::error_info_injector.35"*
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector.35"* %4, %"struct.boost::exception_detail::error_info_injector.35"* %6)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %7 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8***
  ...
  %8 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %8, i32 8
  %9 = bitcast i8* %add.ptr to i8***
  ...
  %10 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %add.ptr2 = getelementptr inbounds i8* %10, i32 28
  %11 = bitcast i8* %add.ptr2 to i8***
  ...
  %add.ptr3 = getelementptr inbounds i8* %12, i32 8
  %13 = bitcast i8* %add.ptr3 to %"class.boost::exception"*
  %14 = load %"class.boost::exception_detail::clone_impl.34"** %x.addr, align 4
  %15 = icmp eq %"class.boost::exception_detail::clone_impl.34"* %14, null
  br i1 %15, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %16 = bitcast %"class.boost::exception_detail::clone_impl.34"* %14 to i8*
  %add.ptr4 = getelementptr inbounds i8* %16, i32 8
  %17 = bitcast i8* %add.ptr4 to %"class.boost::exception"*
  br label %cast.end
...
lpad5:                                            ; preds = %cast.end
  ...
  %23 = extractvalue { i8*, i32 } %21, 1
  store i32 %23, i32* %ehselector.slot
  %24 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to %"struct.boost::exception_detail::error_info_injector.35"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector.35"* %24) nounwind
  br label %ehcleanup

ehcleanup:                                        ; preds = %lpad5, %lpad
  %25 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %26 = getelementptr inbounds i8* %25, i64 28
  %27 = bitcast i8* %26 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %27) nounwind
  br label %eh.resume
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEC1ERKS3_(%"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::gregorian::bad_month"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  %x.addr = alloca %"struct.boost::gregorian::bad_month"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::exception_detail::error_info_injector.35"** %this.addr, align 4
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.35"* %this1, %"struct.boost::gregorian::bad_month"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.35"* %this, %"struct.boost::gregorian::bad_month"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  %x.addr = alloca %"struct.boost::gregorian::bad_month"*, align 4
  %exn.slot = alloca i8*
  ...
  store %"struct.boost::gregorian::bad_month"* %x, %"struct.boost::gregorian::bad_month"** %x.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.35"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to %"struct.boost::gregorian::bad_month"*
  ...
  %2 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to i8*
  %3 = getelementptr inbounds i8* %2, i64 8
  %4 = bitcast i8* %3 to %"class.boost::exception"*
  invoke void @_ZN5boost9exceptionC2Ev(%"class.boost::exception"* %4)
          to label %invoke.cont unwind label %lpad
...
invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to i8***
  ...
  %6 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %6, i32 8
  %7 = bitcast i8* %add.ptr to i8***
...
lpad:                                             ; preds = %entry
  ...
  %10 = extractvalue { i8*, i32 } %8, 1
  store i32 %10, i32* %ehselector.slot
  %11 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %this1 to %"struct.boost::gregorian::bad_month"*
...
define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian9bad_monthEEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl.34"* %this, %"struct.boost::exception_detail::error_info_injector.35"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.34"*, align 4
  %x.addr = alloca %"struct.boost::exception_detail::error_info_injector.35"*, align 4
  %exn.slot = alloca i8*
  ...
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2Ev(%"class.boost::exception_detail::clone_base"* %2) nounwind
  %3 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to %"struct.boost::exception_detail::error_info_injector.35"*
  %4 = load %"struct.boost::exception_detail::error_info_injector.35"** %x.addr, align 4
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector.35"* %3, %"struct.boost::exception_detail::error_info_injector.35"* %4)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8***
  ...
  %6 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %6, i32 8
  %7 = bitcast i8* %add.ptr to i8***
  ...
  %add.ptr3 = getelementptr inbounds i8* %10, i32 8
  %11 = bitcast i8* %add.ptr3 to %"class.boost::exception"*
  %12 = load %"struct.boost::exception_detail::error_info_injector.35"** %x.addr, align 4
  %13 = icmp eq %"struct.boost::exception_detail::error_info_injector.35"* %12, null
  br i1 %13, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %14 = bitcast %"struct.boost::exception_detail::error_info_injector.35"* %12 to i8*
  %add.ptr4 = getelementptr inbounds i8* %14, i32 8
  %15 = bitcast i8* %add.ptr4 to %"class.boost::exception"*
  br label %cast.end
...
lpad5:                                            ; preds = %cast.end
  ...
  %21 = extractvalue { i8*, i32 } %19, 1
  store i32 %21, i32* %ehselector.slot
  %22 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to %"struct.boost::exception_detail::error_info_injector.35"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian9bad_monthEED2Ev(%"struct.boost::exception_detail::error_info_injector.35"* %22) nounwind
  br label %ehcleanup

ehcleanup:                                        ; preds = %lpad5, %lpad
  %23 = bitcast %"class.boost::exception_detail::clone_impl.34"* %this1 to i8*
  %24 = getelementptr inbounds i8* %23, i64 28
  %25 = bitcast i8* %24 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %25) nounwind
  br label %eh.resume
...
entry:
  ...
  %ref.tmp = alloca %"struct.boost::exception_detail::error_info_injector.38", align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  %cleanup.isactive = alloca i1
  ...
  %exception = call i8* @__cxa_allocate_exception(i32 32) nounwind
  store i1 true, i1* %cleanup.isactive
  %2 = bitcast i8* %exception to %"class.boost::exception_detail::clone_impl.37"*
  %3 = load %"struct.boost::gregorian::bad_year"** %e.addr, align 4
  invoke void @_ZN5boost17enable_error_infoINS_9gregorian8bad_yearEEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS5_(%"struct.boost::exception_detail::error_info_injector.38"* sret %ref.tmp, %"struct.boost::gregorian::bad_year"* %3)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  invoke void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEEEENS1_10clone_implIT_EERKS7_(%"class.boost::exception_detail::clone_impl.37"* sret %2, %"struct.boost::exception_detail::error_info_injector.38"* %ref.tmp)
          to label %invoke.cont2 unwind label %lpad1
...
lpad1:                                            ; preds = %invoke.cont2, %invoke.cont
  ...
  %9 = extractvalue { i8*, i32 } %7, 1
  store i32 %9, i32* %ehselector.slot
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED1Ev(%"struct.boost::exception_detail::error_info_injector.38"* %ref.tmp) nounwind
  br label %ehcleanup
...
entry:
  ...
  %0 = bitcast %"struct.boost::gregorian::bad_year"* %this1 to %"class.std::out_of_range"*
  call void @_ZNSaIcEC1Ev(%"class.std::allocator"* %ref.tmp2) nounwind
  invoke void @_ZNSsC1EPKcRKSaIcE(%"class.std::basic_string"* %ref.tmp, i8* getelementptr inbounds ([40 x i8]* @.str17, i32 0, i32 0), %"class.std::allocator"* %ref.tmp2)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEEEENS1_10clone_implIT_EERKS7_(%"class.boost::exception_detail::clone_impl.37"* noalias sret %agg.result, %"struct.boost::exception_detail::error_info_injector.38"* %x) inlinehint {
entry:
  %x.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.38"* %x, %"struct.boost::exception_detail::error_info_injector.38"** %x.addr, align 4
  %0 = load %"struct.boost::exception_detail::error_info_injector.38"** %x.addr, align 4
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl.37"* %agg.result, %"struct.boost::exception_detail::error_info_injector.38"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost17enable_error_infoINS_9gregorian8bad_yearEEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS5_(%"struct.boost::exception_detail::error_info_injector.38"* noalias sret %agg.result, %"struct.boost::gregorian::bad_year"* %x) inlinehint {
entry:
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEC1ERKS3_(%"struct.boost::exception_detail::error_info_injector.38"* %agg.result, %"struct.boost::gregorian::bad_year"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED1Ev(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED2Ev(%"class.boost::exception_detail::clone_impl.37"* %this1, i8** getelementptr inbounds ([2 x i8*]* @_ZTTN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEE, i64 0, i64 0)) nounwind
  %0 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 28
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %2) nounwind
  ret void
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED1Ev(%"struct.boost::exception_detail::error_info_injector.38"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::exception_detail::error_info_injector.38"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.38"** %this.addr
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED2Ev(%"struct.boost::exception_detail::error_info_injector.38"* %this1) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED2Ev(%"struct.boost::exception_detail::error_info_injector.38"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::exception_detail::error_info_injector.38"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.38"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 8
  %2 = bitcast i8* %1 to %"class.boost::exception"*
  call void @_ZN5boost9exceptionD2Ev(%"class.boost::exception"* %2) nounwind
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to %"struct.boost::gregorian::bad_year"*
  call void @_ZN5boost9gregorian8bad_yearD2Ev(%"struct.boost::gregorian::bad_year"* %3) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED1Ev(%"struct.boost::exception_detail::error_info_injector.38"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::exception_detail::error_info_injector.38"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.38"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"struct.boost::exception_detail::error_info_injector.38"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED1Ev(%"struct.boost::exception_detail::error_info_injector.38"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED2Ev(%"class.boost::exception_detail::clone_impl.37"* %this, i8** %vtt) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  %vtt.addr = alloca i8**, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  %vtt2 = load i8*** %vtt.addr
  %0 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to %"struct.boost::exception_detail::error_info_injector.38"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED2Ev(%"struct.boost::exception_detail::error_info_injector.38"* %0) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED1Ev(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  %0 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_impl.37"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED1Ev(%"class.boost::exception_detail::clone_impl.37"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED1Ev(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  ...
  %5 = load i32* %4
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.37"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED1Ev(%"class.boost::exception_detail::clone_impl.37"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED0Ev(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED1Ev(%"class.boost::exception_detail::clone_impl.37"* %this1) nounwind
  %0 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE5cloneEv(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  %call = call noalias i8* @_Znwj(i32 32)
  %0 = bitcast i8* %call to %"class.boost::exception_detail::clone_impl.37"*
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEC1ERKS6_NS6_9clone_tagE(%"class.boost::exception_detail::clone_impl.37"* %0, %"class.boost::exception_detail::clone_impl.37"* %this1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %1 = icmp eq %"class.boost::exception_detail::clone_impl.37"* %0, null
  br i1 %1, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %2 = bitcast %"class.boost::exception_detail::clone_impl.37"* %0 to i8**
  %vtable = load i8** %2
  %vbase.offset.ptr = getelementptr i8* %vtable, i64 -12
  %3 = bitcast i8* %vbase.offset.ptr to i32*
  %vbase.offset = load i32* %3
  %4 = bitcast %"class.boost::exception_detail::clone_impl.37"* %0 to i8*
  %add.ptr = getelementptr inbounds i8* %4, i32 %vbase.offset
  %5 = bitcast i8* %add.ptr to %"class.boost::exception_detail::clone_base"*
  br label %cast.end
...
define linkonce_odr void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  %exception = call i8* @__cxa_allocate_exception(i32 32) nounwind
  %0 = bitcast i8* %exception to %"class.boost::exception_detail::clone_impl.37"*
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEC1ERKS6_(%"class.boost::exception_detail::clone_impl.37"* %0, %"class.boost::exception_detail::clone_impl.37"* %this1)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED0Ev(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_impl.37"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED0Ev(%"class.boost::exception_detail::clone_impl.37"* %2) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE5cloneEv(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.37"*
  %call = call %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE5cloneEv(%"class.boost::exception_detail::clone_impl.37"* %7)
  ret %"class.boost::exception_detail::clone_base"* %call
}

define linkonce_odr void @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.37"*
  call void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.37"* %7)
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED0Ev(%"class.boost::exception_detail::clone_impl.37"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.37"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEED0Ev(%"class.boost::exception_detail::clone_impl.37"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEC1ERKS6_(%"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  %.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %0, %"class.boost::exception_detail::clone_impl.37"** %.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  %1 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %2 = getelementptr inbounds i8* %1, i64 28
  %3 = bitcast i8* %2 to %"class.boost::exception_detail::clone_base"*
  %4 = load %"class.boost::exception_detail::clone_impl.37"** %.addr, align 4
  %5 = bitcast %"class.boost::exception_detail::clone_impl.37"* %4 to i8**
  %vtable = load i8** %5
  %vbase.offset.ptr = getelementptr i8* %vtable, i64 -12
  %6 = bitcast i8* %vbase.offset.ptr to i32*
  %vbase.offset = load i32* %6
  %7 = bitcast %"class.boost::exception_detail::clone_impl.37"* %4 to i8*
  %add.ptr = getelementptr inbounds i8* %7, i32 %vbase.offset
  %8 = bitcast i8* %add.ptr to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2ERKS1_(%"class.boost::exception_detail::clone_base"* %3, %"class.boost::exception_detail::clone_base"* %8) nounwind
  %9 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to %"struct.boost::exception_detail::error_info_injector.38"*
  %10 = load %"class.boost::exception_detail::clone_impl.37"** %.addr, align 4
  %11 = bitcast %"class.boost::exception_detail::clone_impl.37"* %10 to %"struct.boost::exception_detail::error_info_injector.38"*
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector.38"* %9, %"struct.boost::exception_detail::error_info_injector.38"* %11)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %12 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8***
  ...
  %13 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %add.ptr2 = getelementptr inbounds i8* %13, i32 8
  %14 = bitcast i8* %add.ptr2 to i8***
  ...
  %15 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %add.ptr3 = getelementptr inbounds i8* %15, i32 28
  %16 = bitcast i8* %add.ptr3 to i8***
...
lpad:                                             ; preds = %entry
  ...
  %19 = extractvalue { i8*, i32 } %17, 1
  store i32 %19, i32* %ehselector.slot
  %20 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %21 = getelementptr inbounds i8* %20, i64 28
  %22 = bitcast i8* %21 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %22) nounwind
  br label %eh.resume
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::exception_detail::error_info_injector.38"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  %.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::exception_detail::error_info_injector.38"** %this.addr, align 4
  store %"struct.boost::exception_detail::error_info_injector.38"* %0, %"struct.boost::exception_detail::error_info_injector.38"** %.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.38"** %this.addr
  %1 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to %"struct.boost::gregorian::bad_year"*
  %2 = load %"struct.boost::exception_detail::error_info_injector.38"** %.addr, align 4
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %2 to %"struct.boost::gregorian::bad_year"*
  call void @_ZN5boost9gregorian8bad_yearC2ERKS1_(%"struct.boost::gregorian::bad_year"* %1, %"struct.boost::gregorian::bad_year"* %3)
  %4 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to i8*
  %5 = getelementptr inbounds i8* %4, i64 8
  %6 = bitcast i8* %5 to %"class.boost::exception"*
  %7 = load %"struct.boost::exception_detail::error_info_injector.38"** %.addr, align 4
  %8 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %7 to i8*
  %add.ptr = getelementptr inbounds i8* %8, i32 8
  %9 = bitcast i8* %add.ptr to %"class.boost::exception"*
  invoke void @_ZN5boost9exceptionC2ERKS0_(%"class.boost::exception"* %6, %"class.boost::exception"* %9)
          to label %invoke.cont unwind label %lpad
...
invoke.cont:                                      ; preds = %entry
  %10 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to i8***
  ...
  %11 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to i8*
  %add.ptr2 = getelementptr inbounds i8* %11, i32 8
  %12 = bitcast i8* %add.ptr2 to i8***
...
lpad:                                             ; preds = %entry
  ...
  %15 = extractvalue { i8*, i32 } %13, 1
  store i32 %15, i32* %ehselector.slot
  %16 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to %"struct.boost::gregorian::bad_year"*
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED0Ev(%"struct.boost::exception_detail::error_info_injector.38"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::exception_detail::error_info_injector.38"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.38"** %this.addr
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED1Ev(%"struct.boost::exception_detail::error_info_injector.38"* %this1) nounwind
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED0Ev(%"struct.boost::exception_detail::error_info_injector.38"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::exception_detail::error_info_injector.38"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.38"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"struct.boost::exception_detail::error_info_injector.38"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED0Ev(%"struct.boost::exception_detail::error_info_injector.38"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEC1ERKS6_NS6_9clone_tagE(%"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  %x.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  ...
  %ehselector.slot = alloca i32
  store %"class.boost::exception_detail::clone_impl.37"* %this, %"class.boost::exception_detail::clone_impl.37"** %this.addr, align 4
  store %"class.boost::exception_detail::clone_impl.37"* %x, %"class.boost::exception_detail::clone_impl.37"** %x.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.37"** %this.addr
  %1 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %2 = getelementptr inbounds i8* %1, i64 28
  %3 = bitcast i8* %2 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2Ev(%"class.boost::exception_detail::clone_base"* %3) nounwind
  %4 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to %"struct.boost::exception_detail::error_info_injector.38"*
  %5 = load %"class.boost::exception_detail::clone_impl.37"** %x.addr, align 4
  %6 = bitcast %"class.boost::exception_detail::clone_impl.37"* %5 to %"struct.boost::exception_detail::error_info_injector.38"*
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector.38"* %4, %"struct.boost::exception_detail::error_info_injector.38"* %6)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %7 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8***
  ...
  %8 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %8, i32 8
  %9 = bitcast i8* %add.ptr to i8***
  ...
  %10 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %add.ptr2 = getelementptr inbounds i8* %10, i32 28
  %11 = bitcast i8* %add.ptr2 to i8***
  ...
  %add.ptr3 = getelementptr inbounds i8* %12, i32 8
  %13 = bitcast i8* %add.ptr3 to %"class.boost::exception"*
  %14 = load %"class.boost::exception_detail::clone_impl.37"** %x.addr, align 4
  %15 = icmp eq %"class.boost::exception_detail::clone_impl.37"* %14, null
  br i1 %15, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %16 = bitcast %"class.boost::exception_detail::clone_impl.37"* %14 to i8*
  %add.ptr4 = getelementptr inbounds i8* %16, i32 8
  %17 = bitcast i8* %add.ptr4 to %"class.boost::exception"*
  br label %cast.end
...
lpad5:                                            ; preds = %cast.end
  ...
  %23 = extractvalue { i8*, i32 } %21, 1
  store i32 %23, i32* %ehselector.slot
  %24 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to %"struct.boost::exception_detail::error_info_injector.38"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED2Ev(%"struct.boost::exception_detail::error_info_injector.38"* %24) nounwind
  br label %ehcleanup

ehcleanup:                                        ; preds = %lpad5, %lpad
  %25 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %26 = getelementptr inbounds i8* %25, i64 28
  %27 = bitcast i8* %26 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %27) nounwind
  br label %eh.resume
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEC1ERKS3_(%"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::gregorian::bad_year"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  %x.addr = alloca %"struct.boost::gregorian::bad_year"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::exception_detail::error_info_injector.38"** %this.addr, align 4
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.38"* %this1, %"struct.boost::gregorian::bad_year"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.38"* %this, %"struct.boost::gregorian::bad_year"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  %x.addr = alloca %"struct.boost::gregorian::bad_year"*, align 4
  %exn.slot = alloca i8*
  ...
  store %"struct.boost::gregorian::bad_year"* %x, %"struct.boost::gregorian::bad_year"** %x.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.38"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to %"struct.boost::gregorian::bad_year"*
  ...
  %2 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to i8*
  %3 = getelementptr inbounds i8* %2, i64 8
  %4 = bitcast i8* %3 to %"class.boost::exception"*
  invoke void @_ZN5boost9exceptionC2Ev(%"class.boost::exception"* %4)
          to label %invoke.cont unwind label %lpad
...
invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to i8***
  ...
  %6 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %6, i32 8
  %7 = bitcast i8* %add.ptr to i8***
...
lpad:                                             ; preds = %entry
  ...
  %10 = extractvalue { i8*, i32 } %8, 1
  store i32 %10, i32* %ehselector.slot
  %11 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %this1 to %"struct.boost::gregorian::bad_year"*
...
define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl.37"* %this, %"struct.boost::exception_detail::error_info_injector.38"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.37"*, align 4
  %x.addr = alloca %"struct.boost::exception_detail::error_info_injector.38"*, align 4
  %exn.slot = alloca i8*
  ...
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2Ev(%"class.boost::exception_detail::clone_base"* %2) nounwind
  %3 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to %"struct.boost::exception_detail::error_info_injector.38"*
  %4 = load %"struct.boost::exception_detail::error_info_injector.38"** %x.addr, align 4
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEEC2ERKS4_(%"struct.boost::exception_detail::error_info_injector.38"* %3, %"struct.boost::exception_detail::error_info_injector.38"* %4)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8***
  ...
  %6 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %6, i32 8
  %7 = bitcast i8* %add.ptr to i8***
  ...
  %add.ptr3 = getelementptr inbounds i8* %10, i32 8
  %11 = bitcast i8* %add.ptr3 to %"class.boost::exception"*
  %12 = load %"struct.boost::exception_detail::error_info_injector.38"** %x.addr, align 4
  %13 = icmp eq %"struct.boost::exception_detail::error_info_injector.38"* %12, null
  br i1 %13, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %14 = bitcast %"struct.boost::exception_detail::error_info_injector.38"* %12 to i8*
  %add.ptr4 = getelementptr inbounds i8* %14, i32 8
  %15 = bitcast i8* %add.ptr4 to %"class.boost::exception"*
  br label %cast.end
...
lpad5:                                            ; preds = %cast.end
  ...
  %21 = extractvalue { i8*, i32 } %19, 1
  store i32 %21, i32* %ehselector.slot
  %22 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to %"struct.boost::exception_detail::error_info_injector.38"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_9gregorian8bad_yearEED2Ev(%"struct.boost::exception_detail::error_info_injector.38"* %22) nounwind
  br label %ehcleanup

ehcleanup:                                        ; preds = %lpad5, %lpad
  %23 = bitcast %"class.boost::exception_detail::clone_impl.37"* %this1 to i8*
  %24 = getelementptr inbounds i8* %23, i64 28
  %25 = bitcast i8* %24 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %25) nounwind
  br label %eh.resume
...
if.then:                                          ; preds = %entry
  ...
  invoke void @_ZNSsC1EPKcRKSaIcE(%"class.std::basic_string"* %ref.tmp8, i8* getelementptr inbounds ([35 x i8]* @.str18, i32 0, i32 0), %"class.std::allocator"* %ref.tmp9)
          to label %invoke.cont unwind label %lpad
...
entry:
  ...
  %0 = bitcast %"class.boost::date_time::date"* %this1 to %"struct.boost::less_than_comparable.27"*
...
entry:
  ...
  %this1 = load %"class.boost::gregorian::greg_day"** %this.addr
  %0 = bitcast %"class.boost::gregorian::greg_day"* %this1 to %"class.boost::CV::constrained_value.33"*
  %value_ = getelementptr inbounds %"class.boost::CV::constrained_value.33"* %0, i32 0, i32 0
  %1 = load i16* %value_, align 2
  ret i16 %1
}
...
entry:
  ...
  %this1 = load %"class.boost::gregorian::greg_month"** %this.addr
  %0 = bitcast %"class.boost::gregorian::greg_month"* %this1 to %"class.boost::CV::constrained_value.32"*
  %value_ = getelementptr inbounds %"class.boost::CV::constrained_value.32"* %0, i32 0, i32 0
  %1 = load i16* %value_, align 2
  ret i16 %1
}
...
entry:
  ...
  %ref.tmp = alloca %"class.boost::date_time::int_adapter", align 4
  %tmp = alloca %"class.boost::date_time::int_adapter", align 4
  %ref.tmp6 = alloca %"class.boost::date_time::int_adapter.40", align 4
...
if.then:                                          ; preds = %lor.lhs.false3, %lor.lhs.false, %entry
  ...
  call void @_ZNK5boost9date_time4dateINS_9gregorian4dateENS2_18gregorian_calendarENS2_13date_durationEE9day_countEv(%"class.boost::date_time::int_adapter.40"* sret %ref.tmp6, %"class.boost::date_time::date"* %9)
  call void @_ZNK5boost9date_time11int_adapterIxEplIjEES2_RKNS1_IT_EE(%"class.boost::date_time::int_adapter"* sret %ref.tmp, %"class.boost::date_time::int_adapter"* %tmp, %"class.boost::date_time::int_adapter.40"* %ref.tmp6)
...
define linkonce_odr void @_ZNK5boost9date_time11int_adapterIxEplIjEES2_RKNS1_IT_EE(%"class.boost::date_time::int_adapter"* noalias sret %agg.result, %"class.boost::date_time::int_adapter"* %this, %"class.boost::date_time::int_adapter.40"* %rhs) inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::date_time::int_adapter"*, align 4
  %rhs.addr = alloca %"class.boost::date_time::int_adapter.40"*, align 4
  store %"class.boost::date_time::int_adapter"* %this, %"class.boost::date_time::int_adapter"** %this.addr, align 4
  store %"class.boost::date_time::int_adapter.40"* %rhs, %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %this1 = load %"class.boost::date_time::int_adapter"** %this.addr
  %call = call zeroext i1 @_ZNK5boost9date_time11int_adapterIxE10is_specialEv(%"class.boost::date_time::int_adapter"* %this1)
  br i1 %call, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %entry
  %0 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %call2 = call zeroext i1 @_ZNK5boost9date_time11int_adapterIjE10is_specialEv(%"class.boost::date_time::int_adapter.40"* %0)
  br i1 %call2, label %if.then, label %if.end29
...
lor.lhs.false4:                                   ; preds = %if.then
  %1 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %call5 = call zeroext i1 @_ZNK5boost9date_time11int_adapterIjE6is_nanEv(%"class.boost::date_time::int_adapter.40"* %1)
  br i1 %call5, label %if.then6, label %if.end
...
land.lhs.true:                                    ; preds = %if.end
  %3 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %4 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %call8 = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %4)
...
land.lhs.true13:                                  ; preds = %lor.lhs.false10
  %6 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %7 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %call14 = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %7)
...
if.end20:                                         ; preds = %if.end17
  %10 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %11 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %call21 = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %11)
...
if.end24:                                         ; preds = %if.end20
  %12 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %13 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %call25 = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %13)
...
if.end29:                                         ; preds = %if.end28, %lor.lhs.false
  %value_30 = getelementptr inbounds %"class.boost::date_time::int_adapter"* %this1, i32 0, i32 0
  %14 = load i64* %value_30, align 4
  %15 = load %"class.boost::date_time::int_adapter.40"** %rhs.addr, align 4
  %call31 = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %15)
...
define linkonce_odr void @_ZNK5boost9date_time4dateINS_9gregorian4dateENS2_18gregorian_calendarENS2_13date_durationEE9day_countEv(%"class.boost::date_time::int_adapter.40"* noalias sret %agg.result, %"class.boost::date_time::date"* %this) align 2 {
entry:
  %this.addr = alloca %"class.boost::date_time::date"*, align 4
  store %"class.boost::date_time::date"* %this, %"class.boost::date_time::date"** %this.addr, align 4
  %this1 = load %"class.boost::date_time::date"** %this.addr
  %days_ = getelementptr inbounds %"class.boost::date_time::date"* %this1, i32 0, i32 0
  %0 = load i32* %days_, align 4
  call void @_ZN5boost9date_time11int_adapterIjEC1Ej(%"class.boost::date_time::int_adapter.40"* %agg.result, i32 %0)
  ret void
}
...
define linkonce_odr void @_ZN5boost9date_time11int_adapterIjEC1Ej(%"class.boost::date_time::int_adapter.40"* %this, i32 %v) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::date_time::int_adapter.40"*, align 4
  %v.addr = alloca i32, align 4
  store %"class.boost::date_time::int_adapter.40"* %this, %"class.boost::date_time::int_adapter.40"** %this.addr, align 4
  store i32 %v, i32* %v.addr, align 4
  %this1 = load %"class.boost::date_time::int_adapter.40"** %this.addr
  %0 = load i32* %v.addr, align 4
  call void @_ZN5boost9date_time11int_adapterIjEC2Ej(%"class.boost::date_time::int_adapter.40"* %this1, i32 %0)
  ret void
}

define linkonce_odr void @_ZN5boost9date_time11int_adapterIjEC2Ej(%"class.boost::date_time::int_adapter.40"* %this, i32 %v) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::date_time::int_adapter.40"*, align 4
  %v.addr = alloca i32, align 4
  store %"class.boost::date_time::int_adapter.40"* %this, %"class.boost::date_time::int_adapter.40"** %this.addr, align 4
  store i32 %v, i32* %v.addr, align 4
  %this1 = load %"class.boost::date_time::int_adapter.40"** %this.addr
  %value_ = getelementptr inbounds %"class.boost::date_time::int_adapter.40"* %this1, i32 0, i32 0
  %0 = load i32* %v.addr, align 4
  store i32 %0, i32* %value_, align 4
  ret void
}

define linkonce_odr zeroext i1 @_ZNK5boost9date_time11int_adapterIjE10is_specialEv(%"class.boost::date_time::int_adapter.40"* %this) align 2 {
entry:
  %this.addr = alloca %"class.boost::date_time::int_adapter.40"*, align 4
  store %"class.boost::date_time::int_adapter.40"* %this, %"class.boost::date_time::int_adapter.40"** %this.addr, align 4
  %this1 = load %"class.boost::date_time::int_adapter.40"** %this.addr
  %call = call zeroext i1 @_ZNK5boost9date_time11int_adapterIjE11is_infinityEv(%"class.boost::date_time::int_adapter.40"* %this1)
  br i1 %call, label %lor.end, label %lor.rhs

lor.rhs:                                          ; preds = %entry
  %call2 = call zeroext i1 @_ZNK5boost9date_time11int_adapterIjE6is_nanEv(%"class.boost::date_time::int_adapter.40"* %this1)
  br label %lor.end
...
define linkonce_odr zeroext i1 @_ZNK5boost9date_time11int_adapterIjE6is_nanEv(%"class.boost::date_time::int_adapter.40"* %this) align 2 {
entry:
  %this.addr = alloca %"class.boost::date_time::int_adapter.40"*, align 4
  %tmp = alloca %"class.boost::date_time::int_adapter.40", align 4
  store %"class.boost::date_time::int_adapter.40"* %this, %"class.boost::date_time::int_adapter.40"** %this.addr, align 4
  %this1 = load %"class.boost::date_time::int_adapter.40"** %this.addr
  %value_ = getelementptr inbounds %"class.boost::date_time::int_adapter.40"* %this1, i32 0, i32 0
  %0 = load i32* %value_, align 4
  call void @_ZN5boost9date_time11int_adapterIjE12not_a_numberEv(%"class.boost::date_time::int_adapter.40"* sret %tmp)
  %call = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %tmp)
...
entry:
  ...
  store i32 %v, i32* %v.addr, align 4
  %0 = load i32* %v.addr, align 4
  call void @_ZN5boost9date_time11int_adapterIjE12neg_infinityEv(%"class.boost::date_time::int_adapter.40"* sret %tmp)
  %call = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %tmp)
  %cmp = icmp eq i32 %0, %call
  ret i1 %cmp
}

define linkonce_odr i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %this) nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::date_time::int_adapter.40"*, align 4
  store %"class.boost::date_time::int_adapter.40"* %this, %"class.boost::date_time::int_adapter.40"** %this.addr, align 4
  %this1 = load %"class.boost::date_time::int_adapter.40"** %this.addr
...
entry:
  ...
  store i32 %v, i32* %v.addr, align 4
  %0 = load i32* %v.addr, align 4
  call void @_ZN5boost9date_time11int_adapterIjE12pos_infinityEv(%"class.boost::date_time::int_adapter.40"* sret %tmp)
  %call = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %tmp)
  %cmp = icmp eq i32 %0, %call
  ret i1 %cmp
}

define linkonce_odr void @_ZN5boost9date_time11int_adapterIjE12pos_infinityEv(%"class.boost::date_time::int_adapter.40"* noalias sret %agg.result) align 2 {
entry:
  %call = call i32 @_ZNSt14numeric_limitsIjE3maxEv() nounwind
  call void @_ZN5boost9date_time11int_adapterIjEC1Ej(%"class.boost::date_time::int_adapter.40"* %agg.result, i32 %call)
  ret void
}
...
define linkonce_odr void @_ZN5boost9date_time11int_adapterIjE12neg_infinityEv(%"class.boost::date_time::int_adapter.40"* noalias sret %agg.result) align 2 {
entry:
...
define linkonce_odr void @_ZN5boost9date_time11int_adapterIjE12not_a_numberEv(%"class.boost::date_time::int_adapter.40"* noalias sret %agg.result) align 2 {
entry:
  %call = call i32 @_ZNSt14numeric_limitsIjE3maxEv() nounwind
  %sub = sub i32 %call, 1
  call void @_ZN5boost9date_time11int_adapterIjEC1Ej(%"class.boost::date_time::int_adapter.40"* %agg.result, i32 %sub)
  ret void
}

define linkonce_odr zeroext i1 @_ZNK5boost9date_time11int_adapterIjE11is_infinityEv(%"class.boost::date_time::int_adapter.40"* %this) align 2 {
entry:
  %this.addr = alloca %"class.boost::date_time::int_adapter.40"*, align 4
  %tmp = alloca %"class.boost::date_time::int_adapter.40", align 4
  %tmp3 = alloca %"class.boost::date_time::int_adapter.40", align 4
  store %"class.boost::date_time::int_adapter.40"* %this, %"class.boost::date_time::int_adapter.40"** %this.addr, align 4
  %this1 = load %"class.boost::date_time::int_adapter.40"** %this.addr
  %value_ = getelementptr inbounds %"class.boost::date_time::int_adapter.40"* %this1, i32 0, i32 0
  %0 = load i32* %value_, align 4
...
lor.rhs:                                          ; preds = %entry
  %value_2 = getelementptr inbounds %"class.boost::date_time::int_adapter.40"* %this1, i32 0, i32 0
  %1 = load i32* %value_2, align 4
  call void @_ZN5boost9date_time11int_adapterIjE12pos_infinityEv(%"class.boost::date_time::int_adapter.40"* sret %tmp3)
  %call4 = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %tmp3)
...
entry:
  %v.addr = alloca i32, align 4
  %tmp = alloca %"class.boost::date_time::int_adapter.40", align 4
  %tmp1 = alloca %"class.boost::date_time::int_adapter.40", align 4
  store i32 %v, i32* %v.addr, align 4
  %0 = load i32* %v.addr, align 4
  call void @_ZN5boost9date_time11int_adapterIjE12neg_infinityEv(%"class.boost::date_time::int_adapter.40"* sret %tmp)
  %call = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %tmp)
...
lor.rhs:                                          ; preds = %entry
  ...
  call void @_ZN5boost9date_time11int_adapterIjE12pos_infinityEv(%"class.boost::date_time::int_adapter.40"* sret %tmp1)
  %call2 = call i32 @_ZNK5boost9date_time11int_adapterIjE9as_numberEv(%"class.boost::date_time::int_adapter.40"* %tmp1)
...
if.then:                                          ; preds = %entry
  call void @_ZNSaIcEC1Ev(%"class.std::allocator"* %ref.tmp2) nounwind
  invoke void @_ZNSsC1EPKcRKSaIcE(%"class.std::basic_string"* %ref.tmp1, i8* getelementptr inbounds ([44 x i8]* @.str19, i32 0, i32 0), %"class.std::allocator"* %ref.tmp2)
          to label %invoke.cont unwind label %lpad
...
entry:
  ...
  %ref.tmp = alloca %"struct.boost::exception_detail::error_info_injector.42", align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  %cleanup.isactive = alloca i1
  ...
  %exception = call i8* @__cxa_allocate_exception(i32 32) nounwind
  store i1 true, i1* %cleanup.isactive
  %2 = bitcast i8* %exception to %"class.boost::exception_detail::clone_impl.41"*
  %3 = load %"class.std::runtime_error"** %e.addr, align 4
  invoke void @_ZN5boost17enable_error_infoISt13runtime_errorEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS4_(%"struct.boost::exception_detail::error_info_injector.42"* sret %ref.tmp, %"class.std::runtime_error"* %3)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  invoke void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorISt13runtime_errorEEEENS1_10clone_implIT_EERKS6_(%"class.boost::exception_detail::clone_impl.41"* sret %2, %"struct.boost::exception_detail::error_info_injector.42"* %ref.tmp)
          to label %invoke.cont2 unwind label %lpad1

invoke.cont2:                                     ; preds = %invoke.cont
  store i1 false, i1* %cleanup.isactive
  invoke void @__cxa_throw(i8* %exception, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev to i8*)) noreturn
          to label %unreachable unwind label %lpad1
...
lpad1:                                            ; preds = %invoke.cont2, %invoke.cont
  ...
  %9 = extractvalue { i8*, i32 } %7, 1
  store i32 %9, i32* %ehselector.slot
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED1Ev(%"struct.boost::exception_detail::error_info_injector.42"* %ref.tmp) nounwind
  br label %ehcleanup
...
define linkonce_odr void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorISt13runtime_errorEEEENS1_10clone_implIT_EERKS6_(%"class.boost::exception_detail::clone_impl.41"* noalias sret %agg.result, %"struct.boost::exception_detail::error_info_injector.42"* %x) inlinehint {
entry:
  %x.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.42"* %x, %"struct.boost::exception_detail::error_info_injector.42"** %x.addr, align 4
  %0 = load %"struct.boost::exception_detail::error_info_injector.42"** %x.addr, align 4
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEC1ERKS4_(%"class.boost::exception_detail::clone_impl.41"* %agg.result, %"struct.boost::exception_detail::error_info_injector.42"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost17enable_error_infoISt13runtime_errorEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS4_(%"struct.boost::exception_detail::error_info_injector.42"* noalias sret %agg.result, %"class.std::runtime_error"* %x) inlinehint {
entry:
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorEC1ERKS2_(%"struct.boost::exception_detail::error_info_injector.42"* %agg.result, %"class.std::runtime_error"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED2Ev(%"class.boost::exception_detail::clone_impl.41"* %this1, i8** getelementptr inbounds ([2 x i8*]* @_ZTTN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEE, i64 0, i64 0)) nounwind
  %0 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 28
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %2) nounwind
  ret void
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED1Ev(%"struct.boost::exception_detail::error_info_injector.42"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.42"* %this, %"struct.boost::exception_detail::error_info_injector.42"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.42"** %this.addr
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED2Ev(%"struct.boost::exception_detail::error_info_injector.42"* %this1) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED2Ev(%"struct.boost::exception_detail::error_info_injector.42"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.42"* %this, %"struct.boost::exception_detail::error_info_injector.42"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.42"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 8
  %2 = bitcast i8* %1 to %"class.boost::exception"*
  call void @_ZN5boost9exceptionD2Ev(%"class.boost::exception"* %2) nounwind
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to %"class.std::runtime_error"*
  call void @_ZNSt13runtime_errorD2Ev(%"class.std::runtime_error"* %3) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail19error_info_injectorISt13runtime_errorED1Ev(%"struct.boost::exception_detail::error_info_injector.42"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.42"* %this, %"struct.boost::exception_detail::error_info_injector.42"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.42"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"struct.boost::exception_detail::error_info_injector.42"*
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED1Ev(%"struct.boost::exception_detail::error_info_injector.42"* %2) nounwind
  ret void
}

declare void @_ZNSt13runtime_errorD2Ev(%"class.std::runtime_error"*) nounwind

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED2Ev(%"class.boost::exception_detail::clone_impl.41"* %this, i8** %vtt) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  %vtt.addr = alloca i8**, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  %vtt2 = load i8*** %vtt.addr
  %0 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to %"struct.boost::exception_detail::error_info_injector.42"*
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED2Ev(%"struct.boost::exception_detail::error_info_injector.42"* %0) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  %0 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_impl.41"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev(%"class.boost::exception_detail::clone_impl.41"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  ...
  %5 = load i32* %4
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.41"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev(%"class.boost::exception_detail::clone_impl.41"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED0Ev(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev(%"class.boost::exception_detail::clone_impl.41"* %this1) nounwind
  %0 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE5cloneEv(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  %call = call noalias i8* @_Znwj(i32 32)
  %0 = bitcast i8* %call to %"class.boost::exception_detail::clone_impl.41"*
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEC1ERKS5_NS5_9clone_tagE(%"class.boost::exception_detail::clone_impl.41"* %0, %"class.boost::exception_detail::clone_impl.41"* %this1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %1 = icmp eq %"class.boost::exception_detail::clone_impl.41"* %0, null
  br i1 %1, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %2 = bitcast %"class.boost::exception_detail::clone_impl.41"* %0 to i8**
  %vtable = load i8** %2
  %vbase.offset.ptr = getelementptr i8* %vtable, i64 -12
  %3 = bitcast i8* %vbase.offset.ptr to i32*
  %vbase.offset = load i32* %3
  %4 = bitcast %"class.boost::exception_detail::clone_impl.41"* %0 to i8*
  %add.ptr = getelementptr inbounds i8* %4, i32 %vbase.offset
  %5 = bitcast i8* %add.ptr to %"class.boost::exception_detail::clone_base"*
  br label %cast.end
...
define linkonce_odr void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  %exception = call i8* @__cxa_allocate_exception(i32 32) nounwind
  %0 = bitcast i8* %exception to %"class.boost::exception_detail::clone_impl.41"*
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl.41"* %0, %"class.boost::exception_detail::clone_impl.41"* %this1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @__cxa_throw(i8* %exception, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.41"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED1Ev to i8*)) noreturn
  unreachable
...
define linkonce_odr void @_ZThn8_N5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED0Ev(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_impl.41"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED0Ev(%"class.boost::exception_detail::clone_impl.41"* %2) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE5cloneEv(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.41"*
  %call = call %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE5cloneEv(%"class.boost::exception_detail::clone_impl.41"* %7)
  ret %"class.boost::exception_detail::clone_base"* %call
}

define linkonce_odr void @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.41"*
  call void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.41"* %7)
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED0Ev(%"class.boost::exception_detail::clone_impl.41"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.41"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEED0Ev(%"class.boost::exception_detail::clone_impl.41"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  %.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %0, %"class.boost::exception_detail::clone_impl.41"** %.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  %1 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %2 = getelementptr inbounds i8* %1, i64 28
  %3 = bitcast i8* %2 to %"class.boost::exception_detail::clone_base"*
  %4 = load %"class.boost::exception_detail::clone_impl.41"** %.addr, align 4
  %5 = bitcast %"class.boost::exception_detail::clone_impl.41"* %4 to i8**
  %vtable = load i8** %5
  %vbase.offset.ptr = getelementptr i8* %vtable, i64 -12
  %6 = bitcast i8* %vbase.offset.ptr to i32*
  %vbase.offset = load i32* %6
  %7 = bitcast %"class.boost::exception_detail::clone_impl.41"* %4 to i8*
  %add.ptr = getelementptr inbounds i8* %7, i32 %vbase.offset
  %8 = bitcast i8* %add.ptr to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2ERKS1_(%"class.boost::exception_detail::clone_base"* %3, %"class.boost::exception_detail::clone_base"* %8) nounwind
  %9 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to %"struct.boost::exception_detail::error_info_injector.42"*
  %10 = load %"class.boost::exception_detail::clone_impl.41"** %.addr, align 4
  %11 = bitcast %"class.boost::exception_detail::clone_impl.41"* %10 to %"struct.boost::exception_detail::error_info_injector.42"*
  invoke void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.42"* %9, %"struct.boost::exception_detail::error_info_injector.42"* %11)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %12 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8***
  ...
  %13 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %add.ptr2 = getelementptr inbounds i8* %13, i32 8
  %14 = bitcast i8* %add.ptr2 to i8***
  ...
  %15 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %add.ptr3 = getelementptr inbounds i8* %15, i32 28
  %16 = bitcast i8* %add.ptr3 to i8***
...
lpad:                                             ; preds = %entry
  ...
  %19 = extractvalue { i8*, i32 } %17, 1
  store i32 %19, i32* %ehselector.slot
  %20 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %21 = getelementptr inbounds i8* %20, i64 28
  %22 = bitcast i8* %21 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %22) nounwind
  br label %eh.resume
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.42"* %this, %"struct.boost::exception_detail::error_info_injector.42"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  %.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"struct.boost::exception_detail::error_info_injector.42"* %this, %"struct.boost::exception_detail::error_info_injector.42"** %this.addr, align 4
  store %"struct.boost::exception_detail::error_info_injector.42"* %0, %"struct.boost::exception_detail::error_info_injector.42"** %.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.42"** %this.addr
  %1 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to %"class.std::runtime_error"*
  %2 = load %"struct.boost::exception_detail::error_info_injector.42"** %.addr, align 4
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %2 to %"class.std::runtime_error"*
  call void @_ZNSt13runtime_errorC2ERKS_(%"class.std::runtime_error"* %1, %"class.std::runtime_error"* %3)
  %4 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to i8*
  %5 = getelementptr inbounds i8* %4, i64 8
  %6 = bitcast i8* %5 to %"class.boost::exception"*
  %7 = load %"struct.boost::exception_detail::error_info_injector.42"** %.addr, align 4
  %8 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %7 to i8*
  %add.ptr = getelementptr inbounds i8* %8, i32 8
  %9 = bitcast i8* %add.ptr to %"class.boost::exception"*
  invoke void @_ZN5boost9exceptionC2ERKS0_(%"class.boost::exception"* %6, %"class.boost::exception"* %9)
          to label %invoke.cont unwind label %lpad
...
invoke.cont:                                      ; preds = %entry
  %10 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to i8***
  ...
  %11 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to i8*
  %add.ptr2 = getelementptr inbounds i8* %11, i32 8
  %12 = bitcast i8* %add.ptr2 to i8***
...
lpad:                                             ; preds = %entry
  ...
  %15 = extractvalue { i8*, i32 } %13, 1
  store i32 %15, i32* %ehselector.slot
  %16 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to %"class.std::runtime_error"*
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED0Ev(%"struct.boost::exception_detail::error_info_injector.42"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.42"* %this, %"struct.boost::exception_detail::error_info_injector.42"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.42"** %this.addr
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED1Ev(%"struct.boost::exception_detail::error_info_injector.42"* %this1) nounwind
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr void @_ZThn8_N5boost16exception_detail19error_info_injectorISt13runtime_errorED0Ev(%"struct.boost::exception_detail::error_info_injector.42"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.42"* %this, %"struct.boost::exception_detail::error_info_injector.42"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.42"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -8
  %2 = bitcast i8* %1 to %"struct.boost::exception_detail::error_info_injector.42"*
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED0Ev(%"struct.boost::exception_detail::error_info_injector.42"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEC1ERKS5_NS5_9clone_tagE(%"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  %x.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  ...
  %ehselector.slot = alloca i32
  store %"class.boost::exception_detail::clone_impl.41"* %this, %"class.boost::exception_detail::clone_impl.41"** %this.addr, align 4
  store %"class.boost::exception_detail::clone_impl.41"* %x, %"class.boost::exception_detail::clone_impl.41"** %x.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.41"** %this.addr
  %1 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %2 = getelementptr inbounds i8* %1, i64 28
  %3 = bitcast i8* %2 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2Ev(%"class.boost::exception_detail::clone_base"* %3) nounwind
  %4 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to %"struct.boost::exception_detail::error_info_injector.42"*
  %5 = load %"class.boost::exception_detail::clone_impl.41"** %x.addr, align 4
  %6 = bitcast %"class.boost::exception_detail::clone_impl.41"* %5 to %"struct.boost::exception_detail::error_info_injector.42"*
  invoke void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.42"* %4, %"struct.boost::exception_detail::error_info_injector.42"* %6)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %7 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8***
  ...
  %8 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %8, i32 8
  %9 = bitcast i8* %add.ptr to i8***
  ...
  %10 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %add.ptr2 = getelementptr inbounds i8* %10, i32 28
  %11 = bitcast i8* %add.ptr2 to i8***
  ...
  %add.ptr3 = getelementptr inbounds i8* %12, i32 8
  %13 = bitcast i8* %add.ptr3 to %"class.boost::exception"*
  %14 = load %"class.boost::exception_detail::clone_impl.41"** %x.addr, align 4
  %15 = icmp eq %"class.boost::exception_detail::clone_impl.41"* %14, null
  br i1 %15, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %16 = bitcast %"class.boost::exception_detail::clone_impl.41"* %14 to i8*
  %add.ptr4 = getelementptr inbounds i8* %16, i32 8
  %17 = bitcast i8* %add.ptr4 to %"class.boost::exception"*
  br label %cast.end
...
lpad5:                                            ; preds = %cast.end
  ...
  %23 = extractvalue { i8*, i32 } %21, 1
  store i32 %23, i32* %ehselector.slot
  %24 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to %"struct.boost::exception_detail::error_info_injector.42"*
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED2Ev(%"struct.boost::exception_detail::error_info_injector.42"* %24) nounwind
  br label %ehcleanup

ehcleanup:                                        ; preds = %lpad5, %lpad
  %25 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %26 = getelementptr inbounds i8* %25, i64 28
  %27 = bitcast i8* %26 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %27) nounwind
  br label %eh.resume
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorEC1ERKS2_(%"struct.boost::exception_detail::error_info_injector.42"* %this, %"class.std::runtime_error"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  %x.addr = alloca %"class.std::runtime_error"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.42"* %this, %"struct.boost::exception_detail::error_info_injector.42"** %this.addr, align 4
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorEC2ERKS2_(%"struct.boost::exception_detail::error_info_injector.42"* %this1, %"class.std::runtime_error"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorEC2ERKS2_(%"struct.boost::exception_detail::error_info_injector.42"* %this, %"class.std::runtime_error"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  %x.addr = alloca %"class.std::runtime_error"*, align 4
  %exn.slot = alloca i8*
  ...
  store %"class.std::runtime_error"* %x, %"class.std::runtime_error"** %x.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.42"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to %"class.std::runtime_error"*
  ...
  %2 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to i8*
  %3 = getelementptr inbounds i8* %2, i64 8
  %4 = bitcast i8* %3 to %"class.boost::exception"*
  invoke void @_ZN5boost9exceptionC2Ev(%"class.boost::exception"* %4)
          to label %invoke.cont unwind label %lpad
...
invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to i8***
  ...
  %6 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %6, i32 8
  %7 = bitcast i8* %add.ptr to i8***
...
lpad:                                             ; preds = %entry
  ...
  %10 = extractvalue { i8*, i32 } %8, 1
  store i32 %10, i32* %ehselector.slot
  %11 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %this1 to %"class.std::runtime_error"*
...
define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorISt13runtime_errorEEEC1ERKS4_(%"class.boost::exception_detail::clone_impl.41"* %this, %"struct.boost::exception_detail::error_info_injector.42"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.41"*, align 4
  %x.addr = alloca %"struct.boost::exception_detail::error_info_injector.42"*, align 4
  %exn.slot = alloca i8*
  ...
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2Ev(%"class.boost::exception_detail::clone_base"* %2) nounwind
  %3 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to %"struct.boost::exception_detail::error_info_injector.42"*
  %4 = load %"struct.boost::exception_detail::error_info_injector.42"** %x.addr, align 4
  invoke void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.42"* %3, %"struct.boost::exception_detail::error_info_injector.42"* %4)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8***
  ...
  %6 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %6, i32 8
  %7 = bitcast i8* %add.ptr to i8***
  ...
  %add.ptr3 = getelementptr inbounds i8* %10, i32 8
  %11 = bitcast i8* %add.ptr3 to %"class.boost::exception"*
  %12 = load %"struct.boost::exception_detail::error_info_injector.42"** %x.addr, align 4
  %13 = icmp eq %"struct.boost::exception_detail::error_info_injector.42"* %12, null
  br i1 %13, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %14 = bitcast %"struct.boost::exception_detail::error_info_injector.42"* %12 to i8*
  %add.ptr4 = getelementptr inbounds i8* %14, i32 8
  %15 = bitcast i8* %add.ptr4 to %"class.boost::exception"*
  br label %cast.end
...
lpad5:                                            ; preds = %cast.end
  ...
  %21 = extractvalue { i8*, i32 } %19, 1
  store i32 %21, i32* %ehselector.slot
  %22 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to %"struct.boost::exception_detail::error_info_injector.42"*
  call void @_ZN5boost16exception_detail19error_info_injectorISt13runtime_errorED2Ev(%"struct.boost::exception_detail::error_info_injector.42"* %22) nounwind
  br label %ehcleanup

ehcleanup:                                        ; preds = %lpad5, %lpad
  %23 = bitcast %"class.boost::exception_detail::clone_impl.41"* %this1 to i8*
  %24 = getelementptr inbounds i8* %23, i64 28
  %25 = bitcast i8* %24 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseD2Ev(%"class.boost::exception_detail::clone_base"* %25) nounwind
  br label %eh.resume
...
define linkonce_odr void @_ZN5boost6detail11thread_dataI12thread_alarmED2Ev(%"class.boost::detail::thread_data"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::thread_data"*, align 4
  store %"class.boost::detail::thread_data"* %this, %"class.boost::detail::thread_data"** %this.addr, align 4
  %this1 = load %"class.boost::detail::thread_data"** %this.addr
...
cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([40 x i8]* @.str20, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8]* @.str21, i32 0, i32 0), i32 52, i8* getelementptr inbounds ([49 x i8]* @__PRETTY_FUNCTION__._ZN5boost18condition_variableD2Ev, i32 0, i32 0)) noreturn nounwind
  unreachable
                                                  ; No predecessors!
  br label %cond.end
...
cond.false5:                                      ; preds = %do.end
  call void @__assert_fail(i8* getelementptr inbounds ([5 x i8]* @.str22, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8]* @.str21, i32 0, i32 0), i32 57, i8* getelementptr inbounds ([49 x i8]* @__PRETTY_FUNCTION__._ZN5boost18condition_variableD2Ev, i32 0, i32 0)) noreturn nounwind
  unreachable
                                                  ; No predecessors!
  br label %cond.end6
...
entry:
  ...
  %temp.lvalue = alloca %"class.std::allocator.46", align 1
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 4
  store %"struct.std::_Rb_tree_node"* %__p, %"struct.std::_Rb_tree_node"** %__p.addr, align 4
  %this1 = load %"class.std::_Rb_tree"** %this.addr
  call void @_ZNKSt8_Rb_treeIPKvSt4pairIKS1_N5boost6detail13tss_data_nodeEESt10_Select1stIS7_ESt4lessIS1_ESaIS7_EE13get_allocatorEv(%"class.std::allocator.46"* sret %temp.lvalue, %"class.std::_Rb_tree"* %this1)
  %0 = bitcast %"class.std::allocator.46"* %temp.lvalue to %"class.__gnu_cxx::new_allocator.47"*
  ...
  %call = invoke %"struct.std::pair.44"* @_ZSt11__addressofISt4pairIKPKvN5boost6detail13tss_data_nodeEEEPT_RS8_(%"struct.std::pair.44"* %_M_value_field)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  invoke void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKvN5boost6detail13tss_data_nodeEEE7destroyEPS8_(%"class.__gnu_cxx::new_allocator.47"* %0, %"struct.std::pair.44"* %call)
          to label %invoke.cont2 unwind label %lpad

invoke.cont2:                                     ; preds = %invoke.cont
  call void @_ZNSaISt4pairIKPKvN5boost6detail13tss_data_nodeEEED1Ev(%"class.std::allocator.46"* %temp.lvalue) nounwind
...
define linkonce_odr void @_ZNKSt8_Rb_treeIPKvSt4pairIKS1_N5boost6detail13tss_data_nodeEESt10_Select1stIS7_ESt4lessIS1_ESaIS7_EE13get_allocatorEv(%"class.std::allocator.46"* noalias sret %agg.result, %"class.std::_Rb_tree"* %this) align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 4
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 4
  %this1 = load %"class.std::_Rb_tree"** %this.addr
  ...
  call void @_ZNSaISt4pairIKPKvN5boost6detail13tss_data_nodeEEEC1ISt13_Rb_tree_nodeIS6_EEERKSaIT_E(%"class.std::allocator.46"* %agg.result, %"class.std::allocator.16"* %call) nounwind
  ret void
}

define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKvN5boost6detail13tss_data_nodeEEE7destroyEPS8_(%"class.__gnu_cxx::new_allocator.47"* %this, %"struct.std::pair.44"* %__p) align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.47"*, align 4
  %__p.addr = alloca %"struct.std::pair.44"*, align 4
  store %"class.__gnu_cxx::new_allocator.47"* %this, %"class.__gnu_cxx::new_allocator.47"** %this.addr, align 4
  store %"struct.std::pair.44"* %__p, %"struct.std::pair.44"** %__p.addr, align 4
  %this1 = load %"class.__gnu_cxx::new_allocator.47"** %this.addr
  %0 = load %"struct.std::pair.44"** %__p.addr, align 4
  call void @_ZNSt4pairIKPKvN5boost6detail13tss_data_nodeEED1Ev(%"struct.std::pair.44"* %0)
  ret void
}

define linkonce_odr %"struct.std::pair.44"* @_ZSt11__addressofISt4pairIKPKvN5boost6detail13tss_data_nodeEEEPT_RS8_(%"struct.std::pair.44"* %__r) nounwind inlinehint {
entry:
  %__r.addr = alloca %"struct.std::pair.44"*, align 4
  store %"struct.std::pair.44"* %__r, %"struct.std::pair.44"** %__r.addr, align 4
  %0 = load %"struct.std::pair.44"** %__r.addr, align 4
  %1 = bitcast %"struct.std::pair.44"* %0 to i8*
  %2 = bitcast i8* %1 to %"struct.std::pair.44"*
  ret %"struct.std::pair.44"* %2
}

define linkonce_odr void @_ZNSaISt4pairIKPKvN5boost6detail13tss_data_nodeEEED1Ev(%"class.std::allocator.46"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.46"*, align 4
  store %"class.std::allocator.46"* %this, %"class.std::allocator.46"** %this.addr, align 4
  %this1 = load %"class.std::allocator.46"** %this.addr
  call void @_ZNSaISt4pairIKPKvN5boost6detail13tss_data_nodeEEED2Ev(%"class.std::allocator.46"* %this1) nounwind
  ret void
}
...
define linkonce_odr void @_ZNSaISt4pairIKPKvN5boost6detail13tss_data_nodeEEED2Ev(%"class.std::allocator.46"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.46"*, align 4
  store %"class.std::allocator.46"* %this, %"class.std::allocator.46"** %this.addr, align 4
  %this1 = load %"class.std::allocator.46"** %this.addr
  %0 = bitcast %"class.std::allocator.46"* %this1 to %"class.__gnu_cxx::new_allocator.47"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKvN5boost6detail13tss_data_nodeEEED2Ev(%"class.__gnu_cxx::new_allocator.47"* %0) nounwind
  ret void
}

define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKvN5boost6detail13tss_data_nodeEEED2Ev(%"class.__gnu_cxx::new_allocator.47"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.47"*, align 4
  store %"class.__gnu_cxx::new_allocator.47"* %this, %"class.__gnu_cxx::new_allocator.47"** %this.addr, align 4
  %this1 = load %"class.__gnu_cxx::new_allocator.47"** %this.addr
...
define linkonce_odr void @_ZNSt4pairIKPKvN5boost6detail13tss_data_nodeEED1Ev(%"struct.std::pair.44"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"struct.std::pair.44"*, align 4
  store %"struct.std::pair.44"* %this, %"struct.std::pair.44"** %this.addr, align 4
  %this1 = load %"struct.std::pair.44"** %this.addr
  call void @_ZNSt4pairIKPKvN5boost6detail13tss_data_nodeEED2Ev(%"struct.std::pair.44"* %this1)
  ret void
}

define linkonce_odr void @_ZNSt4pairIKPKvN5boost6detail13tss_data_nodeEED2Ev(%"struct.std::pair.44"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"struct.std::pair.44"*, align 4
  store %"struct.std::pair.44"* %this, %"struct.std::pair.44"** %this.addr, align 4
  %this1 = load %"struct.std::pair.44"** %this.addr
  %second = getelementptr inbounds %"struct.std::pair.44"* %this1, i32 0, i32 1
...
entry:
  ...
  call void @_ZN5boost10shared_ptrINS_6detail20tss_cleanup_functionEED1Ev(%"class.boost::shared_ptr.45"* %func)
  ret void
}

define linkonce_odr void @_ZN5boost10shared_ptrINS_6detail20tss_cleanup_functionEED1Ev(%"class.boost::shared_ptr.45"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::shared_ptr.45"*, align 4
  store %"class.boost::shared_ptr.45"* %this, %"class.boost::shared_ptr.45"** %this.addr, align 4
  %this1 = load %"class.boost::shared_ptr.45"** %this.addr
  call void @_ZN5boost10shared_ptrINS_6detail20tss_cleanup_functionEED2Ev(%"class.boost::shared_ptr.45"* %this1)
  ret void
}

define linkonce_odr void @_ZN5boost10shared_ptrINS_6detail20tss_cleanup_functionEED2Ev(%"class.boost::shared_ptr.45"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::shared_ptr.45"*, align 4
  store %"class.boost::shared_ptr.45"* %this, %"class.boost::shared_ptr.45"** %this.addr, align 4
  %this1 = load %"class.boost::shared_ptr.45"** %this.addr
  %pn = getelementptr inbounds %"class.boost::shared_ptr.45"* %this1, i32 0, i32 1
  call void @_ZN5boost6detail12shared_countD1Ev(%"class.boost::detail::shared_count"* %pn)
  ret void
}

define linkonce_odr void @_ZNSaISt4pairIKPKvN5boost6detail13tss_data_nodeEEEC1ISt13_Rb_tree_nodeIS6_EEERKSaIT_E(%"class.std::allocator.46"* %this, %"class.std::allocator.16"*) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.46"*, align 4
  ...
  call void @_ZNSaISt4pairIKPKvN5boost6detail13tss_data_nodeEEEC2ISt13_Rb_tree_nodeIS6_EEERKSaIT_E(%"class.std::allocator.46"* %this1, %"class.std::allocator.16"* %1) nounwind
  ret void
}
...
define linkonce_odr void @_ZNSaISt4pairIKPKvN5boost6detail13tss_data_nodeEEEC2ISt13_Rb_tree_nodeIS6_EEERKSaIT_E(%"class.std::allocator.46"* %this, %"class.std::allocator.16"*) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.46"*, align 4
  %.addr = alloca %"class.std::allocator.16"*, align 4
  store %"class.std::allocator.46"* %this, %"class.std::allocator.46"** %this.addr, align 4
  store %"class.std::allocator.16"* %0, %"class.std::allocator.16"** %.addr, align 4
  %this1 = load %"class.std::allocator.46"** %this.addr
  %1 = bitcast %"class.std::allocator.46"* %this1 to %"class.__gnu_cxx::new_allocator.47"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKvN5boost6detail13tss_data_nodeEEEC2Ev(%"class.__gnu_cxx::new_allocator.47"* %1) nounwind
  ret void
}

define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIKPKvN5boost6detail13tss_data_nodeEEEC2Ev(%"class.__gnu_cxx::new_allocator.47"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.47"*, align 4
  store %"class.__gnu_cxx::new_allocator.47"* %this, %"class.__gnu_cxx::new_allocator.47"** %this.addr, align 4
  %this1 = load %"class.__gnu_cxx::new_allocator.47"** %this.addr
...
if.then:                                          ; preds = %entry
  ...
  call void @_ZN5boost21thread_resource_errorC1EiPKc(%"class.boost::thread_resource_error"* %ref.tmp, i32 %1, i8* getelementptr inbounds ([68 x i8]* @.str23, i32 0, i32 0))
...
cond.false:                                       ; preds = %if.then6
  call void @__assert_fail(i8* getelementptr inbounds ([40 x i8]* @.str20, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8]* @.str21, i32 0, i32 0), i32 46, i8* getelementptr inbounds ([48 x i8]* @__PRETTY_FUNCTION__._ZN5boost18condition_variableC2Ev, i32 0, i32 0)) noreturn nounwind
  unreachable
                                                  ; No predecessors!
  br label %cond.end
...
cond.end:                                         ; preds = %6, %cond.true
  ...
  call void @_ZN5boost21thread_resource_errorC1EiPKc(%"class.boost::thread_resource_error"* %ref.tmp10, i32 %7, i8* getelementptr inbounds ([67 x i8]* @.str24, i32 0, i32 0))
...
entry:
  ...
  %ref.tmp = alloca %"struct.boost::exception_detail::error_info_injector.50", align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  %cleanup.isactive = alloca i1
  ...
  store i1 true, i1* %cleanup.isactive
  %2 = bitcast i8* %exception to %"class.boost::exception_detail::clone_impl.49"*
  %3 = load %"class.boost::thread_resource_error"** %e.addr, align 4
  invoke void @_ZN5boost17enable_error_infoINS_21thread_resource_errorEEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS4_(%"struct.boost::exception_detail::error_info_injector.50"* sret %ref.tmp, %"class.boost::thread_resource_error"* %3)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  invoke void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorINS_21thread_resource_errorEEEEENS1_10clone_implIT_EERKS6_(%"class.boost::exception_detail::clone_impl.49"* sret %2, %"struct.boost::exception_detail::error_info_injector.50"* %ref.tmp)
          to label %invoke.cont2 unwind label %lpad1

invoke.cont2:                                     ; preds = %invoke.cont
  store i1 false, i1* %cleanup.isactive
  invoke void @__cxa_throw(i8* %exception, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev to i8*)) noreturn
          to label %unreachable unwind label %lpad1
...
lpad1:                                            ; preds = %invoke.cont2, %invoke.cont
  ...
  %9 = extractvalue { i8*, i32 } %7, 1
  store i32 %9, i32* %ehselector.slot
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED1Ev(%"struct.boost::exception_detail::error_info_injector.50"* %ref.tmp) nounwind
  br label %ehcleanup
...
define linkonce_odr void @_ZN5boost24enable_current_exceptionINS_16exception_detail19error_info_injectorINS_21thread_resource_errorEEEEENS1_10clone_implIT_EERKS6_(%"class.boost::exception_detail::clone_impl.49"* noalias sret %agg.result, %"struct.boost::exception_detail::error_info_injector.50"* %x) inlinehint {
entry:
  %x.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.50"* %x, %"struct.boost::exception_detail::error_info_injector.50"** %x.addr, align 4
  %0 = load %"struct.boost::exception_detail::error_info_injector.50"** %x.addr, align 4
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEC1ERKS4_(%"class.boost::exception_detail::clone_impl.49"* %agg.result, %"struct.boost::exception_detail::error_info_injector.50"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost17enable_error_infoINS_21thread_resource_errorEEENS_16exception_detail29enable_error_info_return_typeIT_E4typeERKS4_(%"struct.boost::exception_detail::error_info_injector.50"* noalias sret %agg.result, %"class.boost::thread_resource_error"* %x) inlinehint {
entry:
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEC1ERKS2_(%"struct.boost::exception_detail::error_info_injector.50"* %agg.result, %"class.boost::thread_resource_error"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED2Ev(%"class.boost::exception_detail::clone_impl.49"* %this1, i8** getelementptr inbounds ([2 x i8*]* @_ZTTN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEE, i64 0, i64 0)) nounwind
  %0 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED1Ev(%"struct.boost::exception_detail::error_info_injector.50"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.50"* %this, %"struct.boost::exception_detail::error_info_injector.50"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.50"** %this.addr
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED2Ev(%"struct.boost::exception_detail::error_info_injector.50"* %this1) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED2Ev(%"struct.boost::exception_detail::error_info_injector.50"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.50"* %this, %"struct.boost::exception_detail::error_info_injector.50"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.50"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 20
  %2 = bitcast i8* %1 to %"class.boost::exception"*
  call void @_ZN5boost9exceptionD2Ev(%"class.boost::exception"* %2) nounwind
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to %"class.boost::thread_resource_error"*
  call void @_ZN5boost21thread_resource_errorD2Ev(%"class.boost::thread_resource_error"* %3) nounwind
  ret void
}

define linkonce_odr void @_ZThn20_N5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED1Ev(%"struct.boost::exception_detail::error_info_injector.50"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.50"* %this, %"struct.boost::exception_detail::error_info_injector.50"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.50"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 -20
  %2 = bitcast i8* %1 to %"struct.boost::exception_detail::error_info_injector.50"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED1Ev(%"struct.boost::exception_detail::error_info_injector.50"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED2Ev(%"class.boost::exception_detail::clone_impl.49"* %this, i8** %vtt) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  %vtt.addr = alloca i8**, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  %vtt2 = load i8*** %vtt.addr
  %0 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to %"struct.boost::exception_detail::error_info_injector.50"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED2Ev(%"struct.boost::exception_detail::error_info_injector.50"* %0) nounwind
  ret void
}

define linkonce_odr void @_ZThn20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  %0 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
  %1 = getelementptr inbounds i8* %0, i64 -20
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_impl.49"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev(%"class.boost::exception_detail::clone_impl.49"* %2) nounwind
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  ...
  %5 = load i32* %4
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.49"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev(%"class.boost::exception_detail::clone_impl.49"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED0Ev(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev(%"class.boost::exception_detail::clone_impl.49"* %this1) nounwind
  %0 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE5cloneEv(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  ...
  %0 = bitcast i8* %call to %"class.boost::exception_detail::clone_impl.49"*
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEC1ERKS5_NS5_9clone_tagE(%"class.boost::exception_detail::clone_impl.49"* %0, %"class.boost::exception_detail::clone_impl.49"* %this1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %1 = icmp eq %"class.boost::exception_detail::clone_impl.49"* %0, null
  br i1 %1, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %2 = bitcast %"class.boost::exception_detail::clone_impl.49"* %0 to i8**
  %vtable = load i8** %2
  %vbase.offset.ptr = getelementptr i8* %vtable, i64 -12
  %3 = bitcast i8* %vbase.offset.ptr to i32*
  %vbase.offset = load i32* %3
  %4 = bitcast %"class.boost::exception_detail::clone_impl.49"* %0 to i8*
  %add.ptr = getelementptr inbounds i8* %4, i32 %vbase.offset
  %5 = bitcast i8* %add.ptr to %"class.boost::exception_detail::clone_base"*
  br label %cast.end
...
define linkonce_odr void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  ...
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  %exception = call i8* @__cxa_allocate_exception(i32 44) nounwind
  %0 = bitcast i8* %exception to %"class.boost::exception_detail::clone_impl.49"*
  invoke void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl.49"* %0, %"class.boost::exception_detail::clone_impl.49"* %this1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @__cxa_throw(i8* %exception, i8* bitcast ({ i8*, i8*, i32, i32, i8*, i32, i8*, i32 }* @_ZTIN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEE to i8*), i8* bitcast (void (%"class.boost::exception_detail::clone_impl.49"*)* @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED1Ev to i8*)) noreturn
  unreachable
...
define linkonce_odr void @_ZThn20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED0Ev(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -20
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_impl.49"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED0Ev(%"class.boost::exception_detail::clone_impl.49"* %2) nounwind
  ret void
}

define linkonce_odr %"class.boost::exception_detail::clone_base"* @_ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE5cloneEv(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.49"*
  %call = call %"class.boost::exception_detail::clone_base"* @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE5cloneEv(%"class.boost::exception_detail::clone_impl.49"* %7)
  ret %"class.boost::exception_detail::clone_base"* %call
}

define linkonce_odr void @_ZTv0_n16_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.49"*
  call void @_ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEE7rethrowEv(%"class.boost::exception_detail::clone_impl.49"* %7)
  ret void
}

define linkonce_odr void @_ZTv0_n20_N5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED0Ev(%"class.boost::exception_detail::clone_impl.49"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  ...
  %6 = getelementptr inbounds i8* %0, i32 %5
  %7 = bitcast i8* %6 to %"class.boost::exception_detail::clone_impl.49"*
  call void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEED0Ev(%"class.boost::exception_detail::clone_impl.49"* %7) nounwind
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEC1ERKS5_(%"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  %.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %0, %"class.boost::exception_detail::clone_impl.49"** %.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  %1 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
  %2 = getelementptr inbounds i8* %1, i64 40
  %3 = bitcast i8* %2 to %"class.boost::exception_detail::clone_base"*
  %4 = load %"class.boost::exception_detail::clone_impl.49"** %.addr, align 4
  %5 = bitcast %"class.boost::exception_detail::clone_impl.49"* %4 to i8**
  %vtable = load i8** %5
  %vbase.offset.ptr = getelementptr i8* %vtable, i64 -12
  %6 = bitcast i8* %vbase.offset.ptr to i32*
  %vbase.offset = load i32* %6
  %7 = bitcast %"class.boost::exception_detail::clone_impl.49"* %4 to i8*
  %add.ptr = getelementptr inbounds i8* %7, i32 %vbase.offset
  %8 = bitcast i8* %add.ptr to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2ERKS1_(%"class.boost::exception_detail::clone_base"* %3, %"class.boost::exception_detail::clone_base"* %8) nounwind
  %9 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to %"struct.boost::exception_detail::error_info_injector.50"*
  %10 = load %"class.boost::exception_detail::clone_impl.49"** %.addr, align 4
  %11 = bitcast %"class.boost::exception_detail::clone_impl.49"* %10 to %"struct.boost::exception_detail::error_info_injector.50"*
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.50"* %9, %"struct.boost::exception_detail::error_info_injector.50"* %11)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %12 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8***
  ...
  %13 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
  ...
  %15 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
...
lpad:                                             ; preds = %entry
  ...
  %19 = extractvalue { i8*, i32 } %17, 1
  store i32 %19, i32* %ehselector.slot
  %20 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.50"* %this, %"struct.boost::exception_detail::error_info_injector.50"*) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  %.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"struct.boost::exception_detail::error_info_injector.50"* %this, %"struct.boost::exception_detail::error_info_injector.50"** %this.addr, align 4
  store %"struct.boost::exception_detail::error_info_injector.50"* %0, %"struct.boost::exception_detail::error_info_injector.50"** %.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.50"** %this.addr
  %1 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to %"class.boost::thread_resource_error"*
  %2 = load %"struct.boost::exception_detail::error_info_injector.50"** %.addr, align 4
  %3 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %2 to %"class.boost::thread_resource_error"*
  ...
  %4 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to i8*
  %5 = getelementptr inbounds i8* %4, i64 20
  %6 = bitcast i8* %5 to %"class.boost::exception"*
  %7 = load %"struct.boost::exception_detail::error_info_injector.50"** %.addr, align 4
  %8 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %7 to i8*
...
invoke.cont:                                      ; preds = %entry
  %10 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to i8***
  ...
  %11 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to i8*
...
lpad:                                             ; preds = %entry
  ...
  %15 = extractvalue { i8*, i32 } %13, 1
  store i32 %15, i32* %ehselector.slot
  %16 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to %"class.boost::thread_resource_error"*
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED0Ev(%"struct.boost::exception_detail::error_info_injector.50"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.50"* %this, %"struct.boost::exception_detail::error_info_injector.50"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.50"** %this.addr
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED1Ev(%"struct.boost::exception_detail::error_info_injector.50"* %this1) nounwind
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to i8*
  call void @_ZdlPv(i8* %0) nounwind
  ret void
}

define linkonce_odr void @_ZThn20_N5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED0Ev(%"struct.boost::exception_detail::error_info_injector.50"* %this) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.50"* %this, %"struct.boost::exception_detail::error_info_injector.50"** %this.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.50"** %this.addr
  ...
  %1 = getelementptr inbounds i8* %0, i64 -20
  %2 = bitcast i8* %1 to %"struct.boost::exception_detail::error_info_injector.50"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED0Ev(%"struct.boost::exception_detail::error_info_injector.50"* %2) nounwind
  ret void
}
...
define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEC1ERKS5_NS5_9clone_tagE(%"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  %x.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  ...
  %ehselector.slot = alloca i32
  store %"class.boost::exception_detail::clone_impl.49"* %this, %"class.boost::exception_detail::clone_impl.49"** %this.addr, align 4
  store %"class.boost::exception_detail::clone_impl.49"* %x, %"class.boost::exception_detail::clone_impl.49"** %x.addr, align 4
  %this1 = load %"class.boost::exception_detail::clone_impl.49"** %this.addr
  %1 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
  %2 = getelementptr inbounds i8* %1, i64 40
  %3 = bitcast i8* %2 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2Ev(%"class.boost::exception_detail::clone_base"* %3) nounwind
  %4 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to %"struct.boost::exception_detail::error_info_injector.50"*
  %5 = load %"class.boost::exception_detail::clone_impl.49"** %x.addr, align 4
  %6 = bitcast %"class.boost::exception_detail::clone_impl.49"* %5 to %"struct.boost::exception_detail::error_info_injector.50"*
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.50"* %4, %"struct.boost::exception_detail::error_info_injector.50"* %6)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %7 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8***
  ...
  %8 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %8, i32 20
  %9 = bitcast i8* %add.ptr to i8***
  ...
  %10 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
  ...
  %13 = bitcast i8* %add.ptr3 to %"class.boost::exception"*
  %14 = load %"class.boost::exception_detail::clone_impl.49"** %x.addr, align 4
  %15 = icmp eq %"class.boost::exception_detail::clone_impl.49"* %14, null
  br i1 %15, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %16 = bitcast %"class.boost::exception_detail::clone_impl.49"* %14 to i8*
...
lpad5:                                            ; preds = %cast.end
  ...
  %23 = extractvalue { i8*, i32 } %21, 1
  store i32 %23, i32* %ehselector.slot
  %24 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to %"struct.boost::exception_detail::error_info_injector.50"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED2Ev(%"struct.boost::exception_detail::error_info_injector.50"* %24) nounwind
  br label %ehcleanup

ehcleanup:                                        ; preds = %lpad5, %lpad
  %25 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
...
define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEC1ERKS2_(%"struct.boost::exception_detail::error_info_injector.50"* %this, %"class.boost::thread_resource_error"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  %x.addr = alloca %"class.boost::thread_resource_error"*, align 4
  store %"struct.boost::exception_detail::error_info_injector.50"* %this, %"struct.boost::exception_detail::error_info_injector.50"** %this.addr, align 4
  ...
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEC2ERKS2_(%"struct.boost::exception_detail::error_info_injector.50"* %this1, %"class.boost::thread_resource_error"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEC2ERKS2_(%"struct.boost::exception_detail::error_info_injector.50"* %this, %"class.boost::thread_resource_error"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  %x.addr = alloca %"class.boost::thread_resource_error"*, align 4
  %exn.slot = alloca i8*
  ...
  store %"class.boost::thread_resource_error"* %x, %"class.boost::thread_resource_error"** %x.addr, align 4
  %this1 = load %"struct.boost::exception_detail::error_info_injector.50"** %this.addr
  %0 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to %"class.boost::thread_resource_error"*
  ...
  %2 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to i8*
  %3 = getelementptr inbounds i8* %2, i64 20
  %4 = bitcast i8* %3 to %"class.boost::exception"*
  invoke void @_ZN5boost9exceptionC2Ev(%"class.boost::exception"* %4)
          to label %invoke.cont unwind label %lpad
...
invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to i8***
  ...
  %6 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to i8*
...
lpad:                                             ; preds = %entry
  ...
  %10 = extractvalue { i8*, i32 } %8, 1
  store i32 %10, i32* %ehselector.slot
  %11 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %this1 to %"class.boost::thread_resource_error"*
...
define linkonce_odr void @_ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_21thread_resource_errorEEEEC1ERKS4_(%"class.boost::exception_detail::clone_impl.49"* %this, %"struct.boost::exception_detail::error_info_injector.50"* %x) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::exception_detail::clone_impl.49"*, align 4
  %x.addr = alloca %"struct.boost::exception_detail::error_info_injector.50"*, align 4
  %exn.slot = alloca i8*
  ...
  %2 = bitcast i8* %1 to %"class.boost::exception_detail::clone_base"*
  call void @_ZN5boost16exception_detail10clone_baseC2Ev(%"class.boost::exception_detail::clone_base"* %2) nounwind
  %3 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to %"struct.boost::exception_detail::error_info_injector.50"*
  %4 = load %"struct.boost::exception_detail::error_info_injector.50"** %x.addr, align 4
  invoke void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEEC2ERKS3_(%"struct.boost::exception_detail::error_info_injector.50"* %3, %"struct.boost::exception_detail::error_info_injector.50"* %4)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8***
  ...
  %6 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
  %add.ptr = getelementptr inbounds i8* %6, i32 20
  %7 = bitcast i8* %add.ptr to i8***
  ...
  %11 = bitcast i8* %add.ptr3 to %"class.boost::exception"*
  %12 = load %"struct.boost::exception_detail::error_info_injector.50"** %x.addr, align 4
  %13 = icmp eq %"struct.boost::exception_detail::error_info_injector.50"* %12, null
  br i1 %13, label %cast.end, label %cast.notnull

cast.notnull:                                     ; preds = %invoke.cont
  %14 = bitcast %"struct.boost::exception_detail::error_info_injector.50"* %12 to i8*
...
lpad5:                                            ; preds = %cast.end
  ...
  %21 = extractvalue { i8*, i32 } %19, 1
  store i32 %21, i32* %ehselector.slot
  %22 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to %"struct.boost::exception_detail::error_info_injector.50"*
  call void @_ZN5boost16exception_detail19error_info_injectorINS_21thread_resource_errorEED2Ev(%"struct.boost::exception_detail::error_info_injector.50"* %22) nounwind
  br label %ehcleanup

ehcleanup:                                        ; preds = %lpad5, %lpad
  %23 = bitcast %"class.boost::exception_detail::clone_impl.49"* %this1 to i8*
...
if.then:                                          ; preds = %entry
  %1 = load i32* %res, align 4
  call void @_ZN5boost21thread_resource_errorC1EiPKc(%"class.boost::thread_resource_error"* %ref.tmp, i32 %1, i8* getelementptr inbounds ([55 x i8]* @.str25, i32 0, i32 0))
  invoke void @_ZN5boost15throw_exceptionINS_21thread_resource_errorEEEvRKT_(%"class.boost::thread_resource_error"* %ref.tmp) noreturn
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZN5boost10shared_ptrINS_6detail16thread_data_baseEEC2INS1_11thread_dataI12thread_alarmEEEEPT_(%"class.boost::shared_ptr"* %this, %"class.boost::detail::thread_data"* %p) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::shared_ptr"*, align 4
  %p.addr = alloca %"class.boost::detail::thread_data"*, align 4
  %exn.slot = alloca i8*
  ...
  call void @_ZN5boost6detail12shared_countC1INS0_11thread_dataI12thread_alarmEEEEPT_(%"class.boost::detail::shared_count"* %pn, %"class.boost::detail::thread_data"* %2)
...
cast.end:                                         ; preds = %cast.notnull, %entry
  ...
  invoke void @_ZN5boost6detail26sp_enable_shared_from_thisINS0_16thread_data_baseENS0_11thread_dataI12thread_alarmEES2_EEvPKNS_10shared_ptrIT_EEPKT0_PKNS_23enable_shared_from_thisIT1_EE(%"class.boost::shared_ptr"* %this1, %"class.boost::detail::thread_data"* %3, %"class.boost::enable_shared_from_this"* %cast.result)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZN5boost6detail12shared_countC1INS0_11thread_dataI12thread_alarmEEEEPT_(%"class.boost::detail::shared_count"* %this, %"class.boost::detail::thread_data"* %p) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::shared_count"*, align 4
  %p.addr = alloca %"class.boost::detail::thread_data"*, align 4
  store %"class.boost::detail::shared_count"* %this, %"class.boost::detail::shared_count"** %this.addr, align 4
  ...
  %this1 = load %"class.boost::detail::shared_count"** %this.addr
  %0 = load %"class.boost::detail::thread_data"** %p.addr, align 4
  call void @_ZN5boost6detail12shared_countC2INS0_11thread_dataI12thread_alarmEEEEPT_(%"class.boost::detail::shared_count"* %this1, %"class.boost::detail::thread_data"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost6detail26sp_enable_shared_from_thisINS0_16thread_data_baseENS0_11thread_dataI12thread_alarmEES2_EEvPKNS_10shared_ptrIT_EEPKT0_PKNS_23enable_shared_from_thisIT1_EE(%"class.boost::shared_ptr"* %ppx, %"class.boost::detail::thread_data"* %py, %"class.boost::enable_shared_from_this"* %pe) inlinehint {
entry:
...
if.then:                                          ; preds = %entry
  ...
  call void @_ZNK5boost23enable_shared_from_thisINS_6detail16thread_data_baseEE22_internal_accept_ownerIS2_NS1_11thread_dataI12thread_alarmEEEEvPKNS_10shared_ptrIT_EEPT0_(%"class.boost::enable_shared_from_this"* %1, %"class.boost::shared_ptr"* %2, %"class.boost::detail::thread_data"* %3)
  br label %if.end
...
define linkonce_odr void @_ZNK5boost23enable_shared_from_thisINS_6detail16thread_data_baseEE22_internal_accept_ownerIS2_NS1_11thread_dataI12thread_alarmEEEEvPKNS_10shared_ptrIT_EEPT0_(%"class.boost::enable_shared_from_this"* %this, %"class.boost::shared_ptr"* %ppx, %"class.boost::detail::thread_data"* %py) align 2 {
entry:
  %this.addr = alloca %"class.boost::enable_shared_from_this"*, align 4
  %ppx.addr = alloca %"class.boost::shared_ptr"*, align 4
  %py.addr = alloca %"class.boost::detail::thread_data"*, align 4
...
define linkonce_odr void @_ZN5boost6detail12shared_countC2INS0_11thread_dataI12thread_alarmEEEEPT_(%"class.boost::detail::shared_count"* %this, %"class.boost::detail::thread_data"* %p) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::shared_count"*, align 4
  %p.addr = alloca %"class.boost::detail::thread_data"*, align 4
  %exn.slot = alloca i8*
...
invoke.cont:                                      ; preds = %entry
  ...
  invoke void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEC1EPS4_(%"class.boost::detail::sp_counted_impl_p"* %0, %"class.boost::detail::thread_data"* %1)
          to label %invoke.cont3 unwind label %lpad2
...
lpad2:                                            ; preds = %invoke.cont
  ...
  invoke void @_ZN5boost14checked_deleteINS_6detail11thread_dataI12thread_alarmEEEEvPT_(%"class.boost::detail::thread_data"* %10)
          to label %invoke.cont6 unwind label %lpad5
...
define linkonce_odr void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEC1EPS4_(%"class.boost::detail::sp_counted_impl_p"* %this, %"class.boost::detail::thread_data"* %px) unnamed_addr align 2 {
entry:
  ...
  call void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEC2EPS4_(%"class.boost::detail::sp_counted_impl_p"* %this1, %"class.boost::detail::thread_data"* %0)
  ret void
}

define linkonce_odr void @_ZN5boost14checked_deleteINS_6detail11thread_dataI12thread_alarmEEEEvPT_(%"class.boost::detail::thread_data"* %x) inlinehint {
entry:
...
define linkonce_odr void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEC2EPS4_(%"class.boost::detail::sp_counted_impl_p"* %this, %"class.boost::detail::thread_data"* %px) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::sp_counted_impl_p"*, align 4
  %px.addr = alloca %"class.boost::detail::thread_data"*, align 4
  store %"class.boost::detail::sp_counted_impl_p"* %this, %"class.boost::detail::sp_counted_impl_p"** %this.addr, align 4
  ...
  store i8** getelementptr inbounds ([7 x i8*]* @_ZTVN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEEE, i64 0, i64 2), i8*** %1
...
define linkonce_odr void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEED1Ev(%"class.boost::detail::sp_counted_impl_p"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::sp_counted_impl_p"*, align 4
  store %"class.boost::detail::sp_counted_impl_p"* %this, %"class.boost::detail::sp_counted_impl_p"** %this.addr, align 4
  %this1 = load %"class.boost::detail::sp_counted_impl_p"** %this.addr
  call void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEED2Ev(%"class.boost::detail::sp_counted_impl_p"* %this1)
  ret void
}

define linkonce_odr void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEED0Ev(%"class.boost::detail::sp_counted_impl_p"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::sp_counted_impl_p"*, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.boost::detail::sp_counted_impl_p"* %this, %"class.boost::detail::sp_counted_impl_p"** %this.addr, align 4
  %this1 = load %"class.boost::detail::sp_counted_impl_p"** %this.addr
  invoke void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEED1Ev(%"class.boost::detail::sp_counted_impl_p"* %this1)
          to label %invoke.cont unwind label %lpad
...
define linkonce_odr void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEE7disposeEv(%"class.boost::detail::sp_counted_impl_p"* %this) unnamed_addr align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::sp_counted_impl_p"*, align 4
  store %"class.boost::detail::sp_counted_impl_p"* %this, %"class.boost::detail::sp_counted_impl_p"** %this.addr, align 4
  %this1 = load %"class.boost::detail::sp_counted_impl_p"** %this.addr
  ...
  call void @_ZN5boost14checked_deleteINS_6detail11thread_dataI12thread_alarmEEEEvPT_(%"class.boost::detail::thread_data"* %0)
  ret void
}
...
define linkonce_odr i8* @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEE11get_deleterERKSt9type_info(%"class.boost::detail::sp_counted_impl_p"* %this, %"class.std::type_info"*) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::sp_counted_impl_p"*, align 4
...
define linkonce_odr void @_ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataI12thread_alarmEEED2Ev(%"class.boost::detail::sp_counted_impl_p"* %this) unnamed_addr inlinehint align 2 {
entry:
  %this.addr = alloca %"class.boost::detail::sp_counted_impl_p"*, align 4
  store %"class.boost::detail::sp_counted_impl_p"* %this, %"class.boost::detail::sp_counted_impl_p"** %this.addr, align 4
  %this1 = load %"class.boost::detail::sp_counted_impl_p"** %this.addr
...
define linkonce_odr void @_ZN12thread_alarmC2Ei(%struct.thread_alarm* %this, i32 %secs) unnamed_addr nounwind align 2 {
entry:
  %this.addr = alloca %struct.thread_alarm*, align 4
  %secs.addr = alloca i32, align 4
  store %struct.thread_alarm* %this, %struct.thread_alarm** %this.addr, align 4
  ...
  %m_secs = getelementptr inbounds %struct.thread_alarm* %this1, i32 0, i32 0
  %0 = load i32* %secs.addr, align 4
  store i32 %0, i32* %m_secs, align 4
  ret void
}
...
!0 = metadata !{i32 4022241, i32 4022248}         
!1 = metadata !{i32 4022553, i32 4022560}         
