...
public class ValuePairItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValuePair_value1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValuePair_value1_feature", "_UI_ValuePair_type"),
	...
	protected void addValue2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValuePair_value2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValuePair_value2_feature", "_UI_ValuePair_type"),
	...
	public String getText(Object object) {
		String label = ((ValuePair)object).getValue1();
		return label == null || label.length() == 0 ?
			getString("_UI_ValuePair_type") :
			getString("_UI_ValuePair_type") + " " + label;
	}
