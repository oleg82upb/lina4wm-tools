...
public class ResumeItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addResumevaluePropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Resumevalue feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addResumevaluePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resume_resumevalue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resume_resumevalue_feature", "_UI_Resume_type"),
	...
	public String getText(Object object) {
		String label = ((Resume)object).getResumevalue();
		return label == null || label.length() == 0 ?
			getString("_UI_Resume_type") :
