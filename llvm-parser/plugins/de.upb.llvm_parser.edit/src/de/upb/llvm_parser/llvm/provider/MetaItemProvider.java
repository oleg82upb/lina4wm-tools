...
/**
 * This is the item provider adapter for a {@link de.upb.llvm_parser.llvm.Meta} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Meta_meta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Meta_meta_feature", "_UI_Meta_type"),
				 LlvmPackage.Literals.META__META,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(LlvmPackage.Literals.META__ARG);
			childrenFeatures.add(LlvmPackage.Literals.META__VALUE);
		}
	...
	{
		String label = ((Meta)object).getMeta();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(LlvmPackage.Literals.META__ARG,
				 LlvmFactory.eINSTANCE.createPredefined()));

		newChildDescriptors.add
			(createChildParameter
				(LlvmPackage.Literals.META__VALUE,
