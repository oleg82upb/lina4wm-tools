...
public class ARITHMETIC_OPItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ARITHMETIC_OP_optype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ARITHMETIC_OP_optype_feature", "_UI_ARITHMETIC_OP_type"),
	...
	protected void addValue1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ARITHMETIC_OP_value1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ARITHMETIC_OP_value1_feature", "_UI_ARITHMETIC_OP_type"),
	...
	protected void addValue2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ARITHMETIC_OP_value2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ARITHMETIC_OP_value2_feature", "_UI_ARITHMETIC_OP_type"),
	...
	public String getText(Object object) {
		String label = ((ARITHMETIC_OP)object).getOptype();
		return label == null || label.length() == 0 ?
			getString("_UI_ARITHMETIC_OP_type") :
			getString("_UI_ARITHMETIC_OP_type") + " " + label;
	}
