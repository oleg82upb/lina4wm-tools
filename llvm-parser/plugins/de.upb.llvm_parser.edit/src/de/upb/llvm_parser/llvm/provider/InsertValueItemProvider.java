...
public class InsertValueItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInsertvaluePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InsertValue_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InsertValue_value_feature", "_UI_InsertValue_type"),
	...
	/**
	 * This adds a property descriptor for the Inserttype feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInserttypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InsertValue_inserttype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InsertValue_inserttype_feature", "_UI_InsertValue_type"),
	...
	/**
	 * This adds a property descriptor for the Insertvalue feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInsertvaluePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InsertValue_insertvalue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InsertValue_insertvalue_feature", "_UI_InsertValue_type"),
	...
	public String getText(Object object) {
		String label = ((InsertValue)object).getValue();
		return label == null || label.length() == 0 ?
			getString("_UI_InsertValue_type") :
			getString("_UI_InsertValue_type") + " " + label;
	}
