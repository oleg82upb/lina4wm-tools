...
/**
 * This is the item provider adapter for a {@link de.upb.llvm_parser.llvm.ARRAY} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ARRAYItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LlvmPackage.Literals.ARRAY__STRUCT);
			childrenFeatures.add(LlvmPackage.Literals.ARRAY__LSTRUCT);
			childrenFeatures.add(LlvmPackage.Literals.ARRAY__RSTRUCT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LlvmPackage.Literals.ARRAY__STRUCT,
				 LlvmFactory.eINSTANCE.createStructure()));

		newChildDescriptors.add
			(createChildParameter
				(LlvmPackage.Literals.ARRAY__LSTRUCT,
				 LlvmFactory.eINSTANCE.createStructure()));

		newChildDescriptors.add
			(createChildParameter
				(LlvmPackage.Literals.ARRAY__RSTRUCT,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == LlvmPackage.Literals.ARRAY__STRUCT ||
			childFeature == LlvmPackage.Literals.ARRAY__LSTRUCT;
