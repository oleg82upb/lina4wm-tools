...
/**
 * This is the item provider adapter for a {@link de.upb.llvm_parser.llvm.ParameterList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterListItemProvider
	...
	protected void addVariablesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterList_variables_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterList_variables_feature", "_UI_ParameterList_type"),
