...
public class CallItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Call_adresstype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Call_adresstype_feature", "_UI_Call_type"),
	...
	protected void addAdressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Call_adress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Call_adress_feature", "_UI_Call_type"),
	...
	public String getText(Object object) {
		String label = ((Call)object).getAdresstype();
