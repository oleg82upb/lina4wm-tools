...
public class AllocItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNumelementstypePropertyDescriptor(object);
			addNumelementsvaluePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alloc_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alloc_type_feature", "_UI_Alloc_type"),
	...
	/**
	 * This adds a property descriptor for the Numelementstype feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumelementstypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alloc_numelementstype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alloc_numelementstype_feature", "_UI_Alloc_type"),
	...
	/**
	 * This adds a property descriptor for the Numelementsvalue feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumelementsvaluePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alloc_numelementsvalue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alloc_numelementsvalue_feature", "_UI_Alloc_type"),
	...
	public String getText(Object object) {
		String label = ((Alloc)object).getType();
