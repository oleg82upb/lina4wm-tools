...
public class JumpTableItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LlvmPackage.Literals.JUMP_TABLE__JTYPES);
			childrenFeatures.add(LlvmPackage.Literals.JUMP_TABLE__JVALUES);
			childrenFeatures.add(LlvmPackage.Literals.JUMP_TABLE__DESTINATIONTYPES);
			childrenFeatures.add(LlvmPackage.Literals.JUMP_TABLE__DESTINATIONS);
		}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == LlvmPackage.Literals.JUMP_TABLE__JTYPES ||
			childFeature == LlvmPackage.Literals.JUMP_TABLE__DESTINATIONTYPES ||
			childFeature == LlvmPackage.Literals.JUMP_TABLE__JVALUES ||
			childFeature == LlvmPackage.Literals.JUMP_TABLE__DESTINATIONS;
