...
/**
 * This is the item provider adapter for a {@link de.upb.llvm_parser.llvm.IndirectBranch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IndirectBranchItemProvider
	 ...
	 * @generated
	 */
	public IndirectBranchItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndirectBranch_adresstype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndirectBranch_adresstype_feature", "_UI_IndirectBranch_type"),
	...
	protected void addAdressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndirectBranch_adress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndirectBranch_adress_feature", "_UI_IndirectBranch_type"),
	...
	/**
	 * This returns IndirectBranch.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IndirectBranch"));
	}
	...
	public String getText(Object object) {
		String label = ((IndirectBranch)object).getAdresstype();
		return label == null || label.length() == 0 ?
			getString("_UI_IndirectBranch_type") :
			getString("_UI_IndirectBranch_type") + " " + label;
	}
