...
public class LOGICAL_OPItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LlvmPackage.Literals.LOGICAL_OP__OPTYPE);
			childrenFeatures.add(LlvmPackage.Literals.LOGICAL_OP__VALUE1);
			childrenFeatures.add(LlvmPackage.Literals.LOGICAL_OP__VALUE2);
		}
	...
	public String getText(Object object) {
		return getString("_UI_LOGICAL_OP_type");
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == LlvmPackage.Literals.LOGICAL_OP__VALUE1 ||
			childFeature == LlvmPackage.Literals.LOGICAL_OP__VALUE2;
