		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cast_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cast_operation_feature", "_UI_Cast_type"),
				 LlvmPackage.Literals.CAST__OPERATION,
				 true,
				 false,
				 false,
