...
/**
 * This is the item provider adapter for a {@link de.upb.llvm_parser.llvm.ExtractValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtractValueItemProvider
	 ...
	 * @generated
	 */
	public ExtractValueItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExtractValue_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExtractValue_type_feature", "_UI_ExtractValue_type"),
				 LlvmPackage.Literals.EXTRACT_VALUE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExtractValue_index_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExtractValue_index_feature", "_UI_ExtractValue_type"),
				 LlvmPackage.Literals.EXTRACT_VALUE__INDEX,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtractValue"));
	}
