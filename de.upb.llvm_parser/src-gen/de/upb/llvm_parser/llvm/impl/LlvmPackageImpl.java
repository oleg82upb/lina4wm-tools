...
public class LlvmPackageImpl extends EPackageImpl implements LlvmPackage {
	 ...
	 * @generated
	 */
	public EAttribute getLocalAlias_Type() {
		return (EAttribute)localAliasEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(localAliasEClass, LOCAL_ALIAS__TYPE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getLocalAlias_Type(), ecorePackage.getEString(), "type", null, 0, 1, LocalAlias.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
