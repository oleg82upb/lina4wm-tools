...
public class FunctionBodyImpl extends MinimalEObjectImpl.Container implements FunctionBody
{
   ...
   * @ordered
   */
  protected EList<MetadataValue> meta;
   ...
   * @ordered
   */
  protected EList<BasicBlock> blocks;
   ...
   * @generated
   */
  public EList<MetadataValue> getMeta()
  {
    if (meta == null)
    {
      meta = new EObjectContainmentEList<MetadataValue>(MetadataValue.class, this, LlvmPackage.FUNCTION_BODY__META);
    }
    return meta;
  }
   ...
   * @generated
   */
  public EList<BasicBlock> getBlocks()
  {
    if (blocks == null)
    {
      blocks = new EObjectContainmentEList<BasicBlock>(BasicBlock.class, this, LlvmPackage.FUNCTION_BODY__BLOCKS);
    }
    return blocks;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case LlvmPackage.FUNCTION_BODY__META:
        getMeta().clear();
        getMeta().addAll((Collection<? extends MetadataValue>)newValue);
        return;
      case LlvmPackage.FUNCTION_BODY__BLOCKS:
        getBlocks().clear();
