 ...
 * <ul>
 *   <li>{@link de.upb.llvm_parser.lLVM.LocalVarInstruction#getName <em>Name</em>}</li>
 *   <li>{@link de.upb.llvm_parser.lLVM.LocalVarInstruction#getInstruction <em>Instruction</em>}</li>
 * </ul>
 * </p>
 *
...
public interface LocalVarInstruction extends MainLevelEntity
{
   ...
   * @see #setName(String)
   * @see de.upb.llvm_parser.lLVM.LLVMPackage#getLocalVarInstruction_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.upb.llvm_parser.lLVM.LocalVarInstruction#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.upb.llvm_parser.lLVM.LLVMPackage#getLocalVarInstruction_Instruction()
  ...
  /**
   * Sets the value of the '{@link de.upb.llvm_parser.lLVM.LocalVarInstruction#getInstruction <em>Instruction</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
