...
public interface LLVMFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Label Str</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Label Str</em>'.
   * @generated
   */
  LabelStr createLabelStr();
  ...
  /**
   * Returns a new object of class '<em>Un Nammed Addr</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Un Nammed Addr</em>'.
   * @generated
   */
  UnNammedAddr createUnNammedAddr();
