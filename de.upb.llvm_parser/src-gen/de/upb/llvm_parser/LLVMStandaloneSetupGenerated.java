...
public class LLVMStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.upb.de/llvm_parser/LLVM")) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("llp", resourceFactory);
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("llp", serviceProvider);
