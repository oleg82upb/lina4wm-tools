...
import de.upb.lina.cfg.controlflow.diagram.edit.policies.TransitionItemSemanticEditPolicy;
...
public class TransitionEditPart extends ConnectionNodeEditPart implements
	...
	public class TransitionFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrappingLabel fTransitionLabel;
		...
		private void createContents() {
			...
			fTransitionLabel.setText("123");

			this.add(fTransitionLabel);
