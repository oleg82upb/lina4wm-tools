...
public class ExpressionsStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new de.upb.lina.lll.ExpressionsRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.upb.de/lina/lll/Expressions")) {
		EPackage.Registry.INSTANCE.put("http://www.upb.de/lina/lll/Expressions", de.upb.lina.lll.expressions.ExpressionsPackage.eINSTANCE);
	}
