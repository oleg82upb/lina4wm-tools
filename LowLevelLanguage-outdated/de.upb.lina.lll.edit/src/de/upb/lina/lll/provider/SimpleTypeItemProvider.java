...
/**
 * This is the item provider adapter for a {@link de.upb.lina.lll.SimpleType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimpleType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimpleType_type_feature", "_UI_SimpleType_type"),
				 LllPackage.Literals.SIMPLE_TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		PrimitiveType labelValue = ((SimpleType)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SimpleType.class)) {
			case LllPackage.SIMPLE_TYPE__TYPE:
