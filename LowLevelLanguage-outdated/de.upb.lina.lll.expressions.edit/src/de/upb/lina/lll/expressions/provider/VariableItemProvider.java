...
/**
 * This is the item provider adapter for a {@link de.upb.lina.lll.expressions.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_varName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_varName_feature", "_UI_Variable_type"),
				 ExpressionsPackage.Literals.VARIABLE__VAR_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Variable)object).getVarName();
