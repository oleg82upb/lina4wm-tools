...
/**
 * This is the item provider adapter for a {@link de.upb.lina.lll.Goto} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GotoItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Goto_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Goto_target_feature", "_UI_Goto_type"),
				 LllPackage.Literals.GOTO__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		InstructionEnum labelValue = ((Goto)object).getInstruction();
