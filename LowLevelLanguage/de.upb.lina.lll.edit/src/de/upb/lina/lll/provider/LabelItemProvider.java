...
/**
 * This is the item provider adapter for a {@link de.upb.lina.lll.Label} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Label_instruction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Label_instruction_feature", "_UI_Label_type"),
				 LllPackage.Literals.LABEL__INSTRUCTION,
				 true,
				 false,
				 true,
				 null,
