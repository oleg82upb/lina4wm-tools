 ...
 * <ul>
 *   <li>{@link de.upb.lina.lll.impl.ComplexTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComplexTypeImpl extends TypeImpl implements ComplexType {
	...
	protected EClass eStaticClass() {
		return LllPackage.Literals.COMPLEX_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LllPackage.COMPLEX_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LllPackage.COMPLEX_TYPE__NAME:
				return getName();
		}
