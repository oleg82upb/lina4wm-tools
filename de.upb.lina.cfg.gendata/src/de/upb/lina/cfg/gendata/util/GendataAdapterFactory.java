...
public class GendataAdapterFactory extends AdapterFactoryImpl
{
	...
	protected GendataSwitch<Adapter> modelSwitch =
		new GendataSwitch<Adapter>() {
			...
			@Override
			public Adapter caseInputTypeList(InputTypeList object) {
			...
			@Override
			public Adapter caseOffsetElement(OffsetElement object) {
				return createOffsetElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.upb.lina.cfg.gendata.InputTypeList <em>Input Type List</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInputTypeListAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.upb.lina.cfg.gendata.OffsetElement <em>Offset Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOffsetElementAdapter() {
		return null;
	}
