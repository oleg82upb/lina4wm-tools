...
public class GendataPackageImpl extends EPackageImpl implements GendataPackage
{
	 ...
	 * @generated
	 */
	private EClass offsetElementEClass = null;
	 ...
	 * @generated
	 */
	public EReference getMemorySizeMapping_Offset() {
		return (EReference)memorySizeMappingEClass.getEStructuralFeatures().get(4);
	}
	...
	public EReference getMemorySizeMapping_GeneratorData() {
		return (EReference)memorySizeMappingEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getMemorySizeMapping_CompleteTypeSize() {
		return (EAttribute)memorySizeMappingEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getInputTypeList_InputType() {
		return (EAttribute)inputTypeListEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getOffsetElement() {
		return offsetElementEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffsetElement_Factor() {
		return (EAttribute)offsetElementEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getOffsetElement_VariableValue() {
		return (EReference)offsetElementEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffsetElement_IntValue() {
		return (EAttribute)offsetElementEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOffsetElement_Constant() {
		return (EAttribute)offsetElementEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getOffsetElement_MemorySizeMapping() {
		return (EReference)offsetElementEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents()
	{
		...
		createEReference(memorySizeMappingEClass, MEMORY_SIZE_MAPPING__OFFSET);
		...
		offsetElementEClass = createEClass(OFFSET_ELEMENT);
		createEAttribute(offsetElementEClass, OFFSET_ELEMENT__FACTOR);
		createEReference(offsetElementEClass, OFFSET_ELEMENT__VARIABLE_VALUE);
		createEAttribute(offsetElementEClass, OFFSET_ELEMENT__INT_VALUE);
		createEAttribute(offsetElementEClass, OFFSET_ELEMENT__CONSTANT);
		createEReference(offsetElementEClass, OFFSET_ELEMENT__MEMORY_SIZE_MAPPING);
	}
	...
	public void initializePackageContents()
	{
		...
		initEReference(getMemorySizeMapping_Offset(), this.getOffsetElement(), this.getOffsetElement_MemorySizeMapping(), "offset", null, 0, -1, MemorySizeMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(offsetElementEClass, OffsetElement.class, "OffsetElement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOffsetElement_Factor(), ecorePackage.getEInt(), "factor", null, 0, 1, OffsetElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOffsetElement_VariableValue(), theLlvmPackage.getValue(), null, "variableValue", null, 0, 1, OffsetElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOffsetElement_IntValue(), ecorePackage.getEInt(), "intValue", null, 0, 1, OffsetElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOffsetElement_Constant(), ecorePackage.getEBoolean(), "constant", null, 0, 1, OffsetElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOffsetElement_MemorySizeMapping(), this.getMemorySizeMapping(), this.getMemorySizeMapping_Offset(), "memorySizeMapping", null, 0, 1, OffsetElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
