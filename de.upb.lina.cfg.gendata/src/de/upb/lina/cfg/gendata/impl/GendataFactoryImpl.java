...
public class GendataFactoryImpl extends EFactoryImpl implements GendataFactory
{
	...
	public EObject create(EClass eClass)
	{
		switch (eClass.getClassifierID()) {
			...
			case GendataPackage.OFFSET_ELEMENT: return createOffsetElement();
			default:
	 ...
	 * @generated
	 */
	public OffsetElement createOffsetElement() {
		OffsetElementImpl offsetElement = new OffsetElementImpl();
