...
public class OldToNewCfgNameMappingImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,String> {
	...
	protected EClass eStaticClass() {
		return GendataPackage.Literals.OLD_TO_NEW_CFG_NAME_MAPPING;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GendataPackage.OLD_TO_NEW_CFG_NAME_MAPPING__KEY, oldKey, key));
	}
