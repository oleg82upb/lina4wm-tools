...
public interface GendataPackage extends EPackage
{
	 ...
	 * @ordered
	 */
	int MEMORY_SIZE_MAPPING__GENERATOR_DATA = 1;
	 ...
	 * @ordered
	 */
	int MEMORY_SIZE_MAPPING__COMPLETE_TYPE_SIZE = 2;
	 ...
	 * @ordered
	 */
	int MEMORY_SIZE_MAPPING__WARNING = 3;
	 ...
	 * @ordered
	 */
	int MEMORY_SIZE_MAPPING__OFFSET = 4;
	...
	/**
	 * The meta object id for the '{@link de.upb.lina.cfg.gendata.impl.OffsetElementImpl <em>Offset Element</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.upb.lina.cfg.gendata.impl.OffsetElementImpl
	 * @see de.upb.lina.cfg.gendata.impl.GendataPackageImpl#getOffsetElement()
	 * @generated
	 */
	int OFFSET_ELEMENT = 11;
	 ...
	 * @ordered
	 */
	int OFFSET_ELEMENT__VARIABLE_VALUE = 1;
	 ...
	 * @ordered
	 */
	int OFFSET_ELEMENT__INT_VALUE = 2;
	 ...
	 * @ordered
	 */
	int OFFSET_ELEMENT__CONSTANT = 3;

	/**
	 * The feature id for the '<em><b>Memory Size Mapping</b></em>' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int OFFSET_ELEMENT__MEMORY_SIZE_MAPPING = 4;

	/**
	 * The number of structural features of the '<em>Offset Element</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int OFFSET_ELEMENT_FEATURE_COUNT = 5;

	/**
	 * The number of operations of the '<em>Offset Element</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int OFFSET_ELEMENT_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the reference list '{@link de.upb.lina.cfg.gendata.GeneratorData#getGlobalVariables <em>Global Variables</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.upb.lina.cfg.gendata.MemorySizeMapping#getOffset <em>Offset</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getMemorySizeMapping_Offset();
	...
	/**
	 * Returns the meta object for class '{@link de.upb.lina.cfg.gendata.OffsetElement <em>Offset Element</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Offset Element</em>'.
	 * @see de.upb.lina.cfg.gendata.OffsetElement
	 * @generated
	 */
	EClass getOffsetElement();

	/**
	 * Returns the meta object for the attribute '{@link de.upb.lina.cfg.gendata.OffsetElement#getFactor <em>Factor</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Factor</em>'.
	 * @see de.upb.lina.cfg.gendata.OffsetElement#getFactor()
	 * @see #getOffsetElement()
	 * @generated
	 */
	EAttribute getOffsetElement_Factor();

	/**
	 * Returns the meta object for the reference '{@link de.upb.lina.cfg.gendata.OffsetElement#getVariableValue <em>Variable Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Variable Value</em>'.
	 * @see de.upb.lina.cfg.gendata.OffsetElement#getVariableValue()
	 * @see #getOffsetElement()
	 * @generated
	 */
	EReference getOffsetElement_VariableValue();

	/**
	 * Returns the meta object for the attribute '{@link de.upb.lina.cfg.gendata.OffsetElement#getIntValue <em>Int Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Int Value</em>'.
	 * @see de.upb.lina.cfg.gendata.OffsetElement#getIntValue()
	 * @see #getOffsetElement()
	 * @generated
	 */
	EAttribute getOffsetElement_IntValue();

	/**
	 * Returns the meta object for the attribute '{@link de.upb.lina.cfg.gendata.OffsetElement#isConstant <em>Constant</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Constant</em>'.
	 * @see de.upb.lina.cfg.gendata.OffsetElement#isConstant()
	 * @see #getOffsetElement()
	 * @generated
	 */
	EAttribute getOffsetElement_Constant();

	/**
	 * Returns the meta object for the container reference '{@link de.upb.lina.cfg.gendata.OffsetElement#getMemorySizeMapping <em>Memory Size Mapping</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Memory Size Mapping</em>'.
	 * @see de.upb.lina.cfg.gendata.OffsetElement#getMemorySizeMapping()
	 * @see #getOffsetElement()
	 * @generated
	 */
	EReference getOffsetElement_MemorySizeMapping();
	...
	interface Literals
	{
		 ...
		 * @generated
		 */
		EReference MEMORY_SIZE_MAPPING__OFFSET = eINSTANCE.getMemorySizeMapping_Offset();
		...
		/**
		 * The meta object literal for the '{@link de.upb.lina.cfg.gendata.impl.OffsetElementImpl <em>Offset Element</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.upb.lina.cfg.gendata.impl.OffsetElementImpl
		 * @see de.upb.lina.cfg.gendata.impl.GendataPackageImpl#getOffsetElement()
		 * @generated
		 */
		EClass OFFSET_ELEMENT = eINSTANCE.getOffsetElement();
		 ...
		 * @generated
		 */
		EAttribute OFFSET_ELEMENT__FACTOR = eINSTANCE.getOffsetElement_Factor();
		 ...
		 * @generated
		 */
		EReference OFFSET_ELEMENT__VARIABLE_VALUE = eINSTANCE.getOffsetElement_VariableValue();
		 ...
		 * @generated
		 */
		EAttribute OFFSET_ELEMENT__INT_VALUE = eINSTANCE.getOffsetElement_IntValue();
		 ...
		 * @generated
		 */
		EAttribute OFFSET_ELEMENT__CONSTANT = eINSTANCE.getOffsetElement_Constant();

		/**
		 * The meta object literal for the '<em><b>Memory Size Mapping</b></em>' container reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference OFFSET_ELEMENT__MEMORY_SIZE_MAPPING = eINSTANCE.getOffsetElement_MemorySizeMapping();
